...
class CWinSupervisor:
    def __init__(self, sPythonFileName, sDictVarName, sLongIdStr):
        ...
        self.lsProgram = LoadWinSVConfigFmFile(sPythonFileName, sDictVarName, sLongIdStr)
...
#--------------------------------------
def StartCWinSupervisor(sPythonFileName, sDictVarName, sLongIdStr):
    ws = CWinSupervisor(sPythonFileName, sDictVarName, sLongIdStr)
...
if __name__ == '__main__':
    ...
    StartCWinSupervisor(sPythonFileName, sDictVarName, sLongIdStr)
