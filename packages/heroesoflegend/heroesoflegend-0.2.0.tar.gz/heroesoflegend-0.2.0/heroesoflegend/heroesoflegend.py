debug = False # for debugging, obviously.

import random
from random import randint
if debug == True: # this is because of how I have things set up before I upload to PyPI.
...
def main():
    if debug == True:
        for _ in range(10000):
            assert type(charGen()) == str
        print("DEBUG COMPLETE, NOTHING IS BROKEN!")
        return
    print(charGen())
