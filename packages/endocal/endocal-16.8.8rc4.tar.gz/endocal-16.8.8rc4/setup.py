...
with open(path.join(doc_dir, 'description.txt'), encoding='utf-8') as f:
    description = f.read()
    long_description = '%s%s' % (summary, description)
...
setup(
    ...
    classifiers=[
        ...
        # Specify the Python versions you support doc_dir. In particular, ensure
    ...
    # You can just specify the packages manually doc_dir if your project is
    ...
    # List run-time dependencies doc_dir.  These will be installed by pip when
    ...
    # installed, specify them doc_dir.  If using Python 2.6 or less, then these
