...
class ClusterApi(object):
    ...
    def get_cluster_config(self, **kwargs):
        ...
        resource_path = '/platform/1/cluster/config'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_cluster_identity(self, **kwargs):
        ...
        resource_path = '/platform/1/cluster/identity'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_cluster_time(self, **kwargs):
        ...
        resource_path = '/platform/1/cluster/time'.replace('{format}', 'json')
        path_params = {}
