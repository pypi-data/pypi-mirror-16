...
_CONSTRAINTSOLVERPARAMETERS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='trace_propagation', full_name='operations_research.ConstraintSolverParameters.trace_propagation', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='trace_search', full_name='operations_research.ConstraintSolverParameters.trace_search', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='print_model', full_name='operations_research.ConstraintSolverParameters.print_model', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='print_model_stats', full_name='operations_research.ConstraintSolverParameters.print_model_stats', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='print_added_constraints', full_name='operations_research.ConstraintSolverParameters.print_added_constraints', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='export_file', full_name='operations_research.ConstraintSolverParameters.export_file', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='disable_solve', full_name='operations_research.ConstraintSolverParameters.disable_solve', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_compact_table', full_name='operations_research.ConstraintSolverParameters.use_compact_table', index=15,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_sat_table', full_name='operations_research.ConstraintSolverParameters.use_sat_table', index=17,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ac4r_table_threshold', full_name='operations_research.ConstraintSolverParameters.ac4r_table_threshold', index=18,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_mdd_table', full_name='operations_research.ConstraintSolverParameters.use_mdd_table', index=19,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_cumulative_edge_finder', full_name='operations_research.ConstraintSolverParameters.use_cumulative_edge_finder', index=20,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_cumulative_time_table', full_name='operations_research.ConstraintSolverParameters.use_cumulative_time_table', index=21,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_sequence_high_demand_tasks', full_name='operations_research.ConstraintSolverParameters.use_sequence_high_demand_tasks', index=22,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_all_possible_disjunctions', full_name='operations_research.ConstraintSolverParameters.use_all_possible_disjunctions', index=23,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_edge_finder_size', full_name='operations_research.ConstraintSolverParameters.max_edge_finder_size', index=24,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='diffn_use_cumulative', full_name='operations_research.ConstraintSolverParameters.diffn_use_cumulative', index=25,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_element_rmq', full_name='operations_research.ConstraintSolverParameters.use_element_rmq', index=26,
