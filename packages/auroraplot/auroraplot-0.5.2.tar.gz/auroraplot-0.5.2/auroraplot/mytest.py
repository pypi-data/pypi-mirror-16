...
ap.add_network('AWN', aurorawatchnet.sites)
...
if switch == 0:
    ...
    q = ap.load_data('AWN', 'LAN1', 'MagData', st, et)
    # q=ap.load_data('SAMNET', 'LAN', 'MagData', st, et)

elif switch == 3:
    st = np.datetime64('2013-01-01T00:00:00Z')
    et = np.datetime64('2013-01-04T12:00:00Z')
    q = ap.load_data('AWN', 'LAN1', 
    ...
    sam = ap.load_data('SAMNET', 'LAN', 'MagData', st, st+day,
                       archive='realtime')
    #z = ap.load_data('AWN', 'LAN1', 
    #                  'TemperatureData', st, et)
    #v = ap.load_data('AWN', 'LAN1', 
    #                  'VoltageData', st, et)
    ...
    q = ap.load_data('AWN', 'LAN1', 'MagData', st, et)
    # q=ap.load_data('SAMNET', 'LAN', 'MagData', st, et)
    z = ap.load_data('AWN', 'LAN1', 'TemperatureData', 
                      st, et)
    v = ap.load_data('AWN', 'LAN1', 
                      'VoltageData', st, et)
