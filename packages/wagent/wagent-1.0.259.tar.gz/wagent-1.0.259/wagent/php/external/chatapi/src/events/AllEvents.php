...
abstract class AllEvents
{
    ...
    public function onCodeRegister($mynumber, $login, $password, $type, $expiration, $kind, $price, $cost, $currency, $price_expiration, $msgId)
    {
    }

    public function onCodeRegisterFailed($mynumber, $status, $reason, $retry_after, $msgId)
    {
    }

    public function onCodeRequest($mynumber, $method, $length, $msgId)
    {
    }

    public function onCodeRequestFailed($mynumber, $method, $reason, $param, $msgId)
    {
    }

    public function onCodeRequestFailedTooRecent($mynumber, $method, $reason, $retry_after, $msgId)
    {
    }

    public function onCodeRequestFailedTooManyGuesses($mynumber, $method, $reason, $retry_after, $msgId)
    {
    }
    ...
    public function onGetClientConfig($mynumber, $msgid, $platform, $clientId,$lg, $lc, $preview, $default, $groups, $call)
    {
    }
    ...
    public function onGetGroupV2Info($mynumber, $group_id, $creator, $creation, $subject, $participants, $admins, $fromGetGroup, , $msgId)
    {
    }
    ...
    public function onGetPrivacySettings($mynumber, $msgid, $values)
    {
    }
    ...
    public function onGetServerProperties($mynumber, $id, $version, $props)
    {
    }
    ...
    public function onGetStatuses($mynumber, $id, $statuses)
    {
    }
    ...
    public function onGroupCreate($mynumber, $groupId, $msgId)
    {
    }
    ...
    public function onGroupLocked($mynumber, $groupId, $msgId)
    {
    }

    public function onGroupsChatCreate($mynumber, $gid, $msgId)
    {
    }
    ...
    public function onGroupsSubjectSet($mynumber, $gid, $msgId)
    {
    }

    public function onGroupUnlocked($mynumber, $groupId, $msgId) 
    {
    }
    ...
    public function onParticipantAdded($mynumber, $groupId, $jid, $msgId)
    {
    }

    public function onParticipantRemoved($mynumber, $groupId, $jid, $msgId) 
    {
    }

    public function onParticipantsDemote($mynumber, $id, $gid, $participants)
    {
    }

    public function onParticipantsPromote($mynumber, $id, $gid, $participants)
    {
    }
    ...
    public function onSetPicture($mynumber, $id)
    {
    }

    public function onStatusUpdate($mynumber, $id) 
    {
    }
