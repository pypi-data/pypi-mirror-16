...
org.nfrac.comportex.demos.sensorimotor_1d.fields = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__6925__auto__ = (function org$nfrac$comportex$demos$sensorimotor_1d$iter__70716(s__70717){
return (new cljs.core.LazySeq(null,(function (){
var s__70717__$1 = s__70717;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__70717__$1);
if(temp__4657__auto__){
var s__70717__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_(s__70717__$2)){
var c__6923__auto__ = cljs.core.chunk_first(s__70717__$2);
var size__6924__auto__ = cljs.core.count(c__6923__auto__);
var b__70719 = cljs.core.chunk_buffer(size__6924__auto__);
if((function (){var i__70718 = (0);
while(true){
if((i__70718 < size__6924__auto__)){
var k = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__6923__auto__,i__70718);
cljs.core.chunk_append(b__70719,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.keyword,cljs.core.str),cljs.core.name(k))], null));

var G__70722 = (i__70718 + (1));
i__70718 = G__70722;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__70719),org$nfrac$comportex$demos$sensorimotor_1d$iter__70716(cljs.core.chunk_rest(s__70717__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__70719),null);
}
} else {
var k = cljs.core.first(s__70717__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.keyword,cljs.core.str),cljs.core.name(k))], null),org$nfrac$comportex$demos$sensorimotor_1d$iter__70716(cljs.core.rest(s__70717__$2)));
}
} else {
return null;
}
...
var vec__70724 = clojure.test.check.random.split(cljs.core.cst$kw$org$nfrac$comportex$demos$sensorimotor_DASH_1d_SLASH_rng.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(m)));
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70724,(0),null);
var rng_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70724,(1),null);
...
var args70725 = [];
var len__7211__auto___70728 = arguments.length;
var i__7212__auto___70729 = (0);
while(true){
if((i__7212__auto___70729 < len__7211__auto___70728)){
args70725.push((arguments[i__7212__auto___70729]));

var G__70730 = (i__7212__auto___70729 + (1));
i__7212__auto___70729 = G__70730;
continue;
} else {
}
break;
