...
return cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(p1__70494_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["."], null)));
});})(text))
,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(((function (text){
return (function (p1__70493_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__70493_SHARP_,/[^\w']+/);
});})(text))
...
var iter__6925__auto__ = (function org$nfrac$comportex$demos$simple_sentences$word_item_seq_$_iter__70532(s__70533){
return (new cljs.core.LazySeq(null,(function (){
var s__70533__$1 = s__70533;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__70533__$1);
if(temp__4657__auto__){
var xs__5205__auto__ = temp__4657__auto__;
var vec__70555 = cljs.core.first(xs__5205__auto__);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70555,(0),null);
var sen = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70555,(1),null);
var iterys__6921__auto__ = ((function (s__70533__$1,vec__70555,i,sen,xs__5205__auto__,temp__4657__auto__){
return (function org$nfrac$comportex$demos$simple_sentences$word_item_seq_$_iter__70532_$_iter__70534(s__70535){
return (new cljs.core.LazySeq(null,((function (s__70533__$1,vec__70555,i,sen,xs__5205__auto__,temp__4657__auto__){
return (function (){
var s__70535__$1 = s__70535;
while(true){
var temp__4657__auto____$1 = cljs.core.seq(s__70535__$1);
if(temp__4657__auto____$1){
var xs__5205__auto____$1 = temp__4657__auto____$1;
var rep = cljs.core.first(xs__5205__auto____$1);
var iterys__6921__auto__ = ((function (s__70535__$1,s__70533__$1,rep,xs__5205__auto____$1,temp__4657__auto____$1,vec__70555,i,sen,xs__5205__auto__,temp__4657__auto__){
return (function org$nfrac$comportex$demos$simple_sentences$word_item_seq_$_iter__70532_$_iter__70534_$_iter__70536(s__70537){
return (new cljs.core.LazySeq(null,((function (s__70535__$1,s__70533__$1,rep,xs__5205__auto____$1,temp__4657__auto____$1,vec__70555,i,sen,xs__5205__auto__,temp__4657__auto__){
return (function (){
var s__70537__$1 = s__70537;
while(true){
var temp__4657__auto____$2 = cljs.core.seq(s__70537__$1);
if(temp__4657__auto____$2){
var s__70537__$2 = temp__4657__auto____$2;
if(cljs.core.chunked_seq_QMARK_(s__70537__$2)){
var c__6923__auto__ = cljs.core.chunk_first(s__70537__$2);
var size__6924__auto__ = cljs.core.count(c__6923__auto__);
var b__70539 = cljs.core.chunk_buffer(size__6924__auto__);
if((function (){var i__70538 = (0);
while(true){
if((i__70538 < size__6924__auto__)){
var vec__70567 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__6923__auto__,i__70538);
var j = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70567,(0),null);
var word = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70567,(1),null);
cljs.core.chunk_append(b__70539,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$word,word,cljs.core.cst$kw$index,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [i,j], null)], null));

var G__70569 = (i__70538 + (1));
i__70538 = G__70569;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__70539),org$nfrac$comportex$demos$simple_sentences$word_item_seq_$_iter__70532_$_iter__70534_$_iter__70536(cljs.core.chunk_rest(s__70537__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__70539),null);
}
} else {
var vec__70568 = cljs.core.first(s__70537__$2);
...
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$word,word,cljs.core.cst$kw$index,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [i,j], null)], null),org$nfrac$comportex$demos$simple_sentences$word_item_seq_$_iter__70532_$_iter__70534_$_iter__70536(cljs.core.rest(s__70537__$2)));
}
} else {
return null;
}
...
});})(s__70535__$1,s__70533__$1,rep,xs__5205__auto____$1,temp__4657__auto____$1,vec__70555,i,sen,xs__5205__auto__,temp__4657__auto__))
,null,null));
});})(s__70535__$1,s__70533__$1,rep,xs__5205__auto____$1,temp__4657__auto____$1,vec__70555,i,sen,xs__5205__auto__,temp__4657__auto__))
;
...
if(fs__6922__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__6922__auto__,org$nfrac$comportex$demos$simple_sentences$word_item_seq_$_iter__70532_$_iter__70534(cljs.core.rest(s__70535__$1)));
} else {
var G__70570 = cljs.core.rest(s__70535__$1);
s__70535__$1 = G__70570;
continue;
}
} else {
return null;
...
});})(s__70533__$1,vec__70555,i,sen,xs__5205__auto__,temp__4657__auto__))
,null,null));
});})(s__70533__$1,vec__70555,i,sen,xs__5205__auto__,temp__4657__auto__))
;
var fs__6922__auto__ = cljs.core.seq(iterys__6921__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(n_repeats)));
if(fs__6922__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__6922__auto__,org$nfrac$comportex$demos$simple_sentences$word_item_seq_$_iter__70532(cljs.core.rest(s__70533__$1)));
} else {
var G__70571 = cljs.core.rest(s__70533__$1);
s__70533__$1 = G__70571;
continue;
}
} else {
return null;
...
var args70572 = [];
var len__7211__auto___70575 = arguments.length;
var i__7212__auto___70576 = (0);
while(true){
if((i__7212__auto___70576 < len__7211__auto___70575)){
args70572.push((arguments[i__7212__auto___70576]));

var G__70577 = (i__7212__auto___70576 + (1));
i__7212__auto___70576 = G__70577;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args70572.length)].join('')));
