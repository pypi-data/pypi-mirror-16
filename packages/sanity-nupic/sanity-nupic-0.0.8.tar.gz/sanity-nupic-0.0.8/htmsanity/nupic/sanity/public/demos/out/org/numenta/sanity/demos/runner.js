...
var len__7211__auto___68288 = arguments.length;
var i__7212__auto___68289 = (0);
while(true){
if((i__7212__auto___68289 < len__7211__auto___68288)){
args__7218__auto__.push((arguments[i__7212__auto___68289]));

var G__68290 = (i__7212__auto___68289 + (1));
i__7212__auto___68289 = G__68290;
continue;
} else {
}
break;
...
return org.numenta.sanity.demos.runner.init.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__7219__auto__);
});
...
var G__68254_68291 = "simulation";
var G__68255_68292 = org.numenta.sanity.util.tap_c(into_sim_mult);
(pipe_to_remote_target_BANG_.cljs$core$IFn$_invoke$arity$2 ? pipe_to_remote_target_BANG_.cljs$core$IFn$_invoke$arity$2(G__68254_68291,G__68255_68292) : pipe_to_remote_target_BANG_.call(null,G__68254_68291,G__68255_68292));

var c__38109__auto___68293 = cljs.core.async.chan.cljs$core$IFn$_invoke$arity$1((1));
cljs.core.async.impl.dispatch.run(((function (c__38109__auto___68293,into_sim_in,into_sim_mult,into_sim_eavesdrop,into_journal,pipe_to_remote_target_BANG_,features){
return (function (){
var f__38110__auto__ = (function (){var switch__37995__auto__ = ((function (c__38109__auto___68293,into_sim_in,into_sim_mult,into_sim_eavesdrop,into_journal,pipe_to_remote_target_BANG_,features){
return (function (state_68272){
var state_val_68273 = (state_68272[(1)]);
if((state_val_68273 === (1))){
var state_68272__$1 = state_68272;
var statearr_68274_68294 = state_68272__$1;
(statearr_68274_68294[(2)] = null);

(statearr_68274_68294[(1)] = (2));


return cljs.core.cst$kw$recur;
} else {
if((state_val_68273 === (2))){
var state_68272__$1 = state_68272;
return cljs.core.async.impl.ioc_helpers.take_BANG_(state_68272__$1,(4),into_sim_eavesdrop);
} else {
if((state_val_68273 === (3))){
var inst_68270 = (state_68272[(2)]);
var state_68272__$1 = state_68272;
return cljs.core.async.impl.ioc_helpers.return_chan(state_68272__$1,inst_68270);
} else {
if((state_val_68273 === (4))){
var inst_68258 = (state_68272[(2)]);
var inst_68259 = (inst_68258 == null);
var state_68272__$1 = state_68272;
if(cljs.core.truth_(inst_68259)){
var statearr_68275_68295 = state_68272__$1;
(statearr_68275_68295[(1)] = (5));

} else {
var statearr_68276_68296 = state_68272__$1;
(statearr_68276_68296[(1)] = (6));

}

return cljs.core.cst$kw$recur;
} else {
if((state_val_68273 === (5))){
var state_68272__$1 = state_68272;
var statearr_68277_68297 = state_68272__$1;
(statearr_68277_68297[(2)] = null);

(statearr_68277_68297[(1)] = (7));


return cljs.core.cst$kw$recur;
} else {
if((state_val_68273 === (6))){
var inst_68262 = cljs.core.PersistentVector.EMPTY_NODE;
var inst_68263 = ["ping"];
var inst_68264 = (new cljs.core.PersistentVector(null,1,(5),inst_68262,inst_68263,null));
var inst_68265 = cljs.core.async.put_BANG_.cljs$core$IFn$_invoke$arity$2(into_journal,inst_68264);
var state_68272__$1 = (function (){var statearr_68278 = state_68272;
(statearr_68278[(7)] = inst_68265);

return statearr_68278;
})();
var statearr_68279_68298 = state_68272__$1;
(statearr_68279_68298[(2)] = null);

(statearr_68279_68298[(1)] = (2));


return cljs.core.cst$kw$recur;
} else {
if((state_val_68273 === (7))){
var inst_68268 = (state_68272[(2)]);
var state_68272__$1 = state_68272;
var statearr_68280_68299 = state_68272__$1;
(statearr_68280_68299[(2)] = inst_68268);

(statearr_68280_68299[(1)] = (3));
...
});})(c__38109__auto___68293,into_sim_in,into_sim_mult,into_sim_eavesdrop,into_journal,pipe_to_remote_target_BANG_,features))
;
return ((function (switch__37995__auto__,c__38109__auto___68293,into_sim_in,into_sim_mult,into_sim_eavesdrop,into_journal,pipe_to_remote_target_BANG_,features){
return (function() {
...
var statearr_68284 = [null,null,null,null,null,null,null,null];
(statearr_68284[(0)] = org$numenta$sanity$demos$runner$state_machine__37996__auto__);

(statearr_68284[(1)] = (1));

return statearr_68284;
});
var org$numenta$sanity$demos$runner$state_machine__37996__auto____1 = (function (state_68272){
while(true){
var ret_value__37997__auto__ = (function (){try{while(true){
var result__37998__auto__ = switch__37995__auto__(state_68272);
...
var ex__37999__auto__ = e68285;
var statearr_68286_68300 = state_68272;
(statearr_68286_68300[(5)] = ex__37999__auto__);


cljs.core.async.impl.ioc_helpers.process_exception(state_68272);
...
var G__68301 = state_68272;
state_68272 = G__68301;
continue;
} else {
...
org$numenta$sanity$demos$runner$state_machine__37996__auto__ = function(state_68272){
switch(arguments.length){
case 0:
return org$numenta$sanity$demos$runner$state_machine__37996__auto____0.call(this);
case 1:
return org$numenta$sanity$demos$runner$state_machine__37996__auto____1.call(this,state_68272);
}
...
;})(switch__37995__auto__,c__38109__auto___68293,into_sim_in,into_sim_mult,into_sim_eavesdrop,into_journal,pipe_to_remote_target_BANG_,features))
})();
var state__38111__auto__ = (function (){var statearr_68287 = (f__38110__auto__.cljs$core$IFn$_invoke$arity$0 ? f__38110__auto__.cljs$core$IFn$_invoke$arity$0() : f__38110__auto__.call(null));
(statearr_68287[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__38109__auto___68293);
...
return org.numenta.sanity.demos.runner.init.cljs$core$IFn$_invoke$arity$variadic(G__68252,G__68253,seq68251__$2);
});
