...
class Instance(object):
    ...
    def __connect__(self, **connect_args):
        try:
            conn = client.AcsClient(connect_args.get('acs_access_key_id'), connect_args.get('acs_secret_access_key'), self.region_id)
            if not conn:
    ...
    def stop(self, force=None, **connect_args):
        try:
            conn = self.__connect__(**connect_args)
    ...
    def reboot(self, force=None, **connect_args):
        try:
            conn = self.__connect__(**connect_args)
