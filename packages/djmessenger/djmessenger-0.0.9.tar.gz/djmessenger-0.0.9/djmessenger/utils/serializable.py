...
class Serializable(object):
    ...
    1. All custom objects must implement Serializable
    ...
    ## excludes
        ...
        excludes and includes are mutually-exclusive
    ...
    def json(self):
        ...
        if self.includes and self.excludes:
            raise AssertionError('includes and excludes are mutually-exclusive,'
                                 'please use only one of them in class %s ' %
