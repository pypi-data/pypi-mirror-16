...
class Flow(object):
    ...
    def __init__(self, flowIdentifier, srcIp, srcPort, dstIp, dstPort, sample):
        ...
        self.timeBeetweenCurrentAndPreviousSample = 0
    ...
    def updateFlow(self, newSample):
        ...
        self.timeBeetweenCurrentAndPreviousSample = self.currentSample.absoluteTimestamp - self.previousSample.absoluteTimestamp
    ...
    def updateDerivedValues(self):
        ...
        self.throughput = (self.currentSample.seq - self.seqLastThroughputCalc) if (self.currentSample.seq - self.seqLastThroughputCalc) >= 0 \
            else (int("0xffffffff",0) - self.seqLastThroughputCalc + self.currentSample.seq)
        self.throughput /= self.timeBeetweenCurrentAndPreviousSample  # byte/s
