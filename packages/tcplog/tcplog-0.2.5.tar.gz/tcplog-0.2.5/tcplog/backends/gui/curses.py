...
# TODO: cleaner?
STATS_TO_PRINT = ['activity', 'elapsed', 'srcIp', 'srcPort', 'dstIp', 'dstPort', 'cwnd', 'sst', 'rtt', 'minRtt', 'maxRtt', 'avgRtt', 'meanRtt', 'smoothedThroughput', 'assumedLosses', 'transferedData']
# STATS_TO_PRINT_UNITS = ['s', 's', '', '', '', '', 'pkt', 'pkt', 'ms', 'ms', 'ms', 'ms', 'ms', 'mbit/s', '', 'byte']
STATS_TO_PRINT_UNITS = ['s', 's', 'ip', 'port', 'ip', 'port', 'pkt', 'pkt', 'ms', 'ms', 'ms', 'ms', 'ms', 'mbit/s', '#', 'byte']
...
class CursesGui(GuiBase):
    ...
    def repaint(self):
        ...
        try:
            ...
            startYindex = 0
            startXindex = 0
            self.outerPad.addnstr(startYindex, startXindex, str("").ljust(5), 5)
            startYindex = 0
            startXindex = 5
            ...
            startYindex = 1
            startXindex = 0
            self.outerPad.addnstr(startYindex, startXindex, str("#").ljust(5), 5, curses.A_BOLD | curses.color_pair(8))
            startYindex = 1
            startXindex = 5
            ...
            for flowKey, flowValue in self.flows.items():
                ...
                self.innerPad.addnstr(startYindex, 0, str(i), 5, cellStyle)
