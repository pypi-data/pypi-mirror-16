...
connection_error_counter = Counter('connection_errors', 'Number of DB connection errors', ['database'])
timeout_error_counter = Counter('timeout_errors', 'Number of DB timeout errors', ['database'])
