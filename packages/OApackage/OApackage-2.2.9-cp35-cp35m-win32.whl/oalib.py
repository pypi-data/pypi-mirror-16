...
class jstruct_t(object):
    ...
    vals = _swig_property(_oalib.jstruct_t_vals_get, _oalib.jstruct_t_vals_set)
...
def free_sols(solutions):
    """free_sols(arraylist_t solutions) -> int"""
    return _oalib.free_sols(solutions)
...
class conference_transformation_t(object):
    ...
    def __mul__(self, b):
        """__mul__(conference_transformation_t self, conference_transformation_t b) -> conference_transformation_t"""
        return _oalib.conference_transformation_t___mul__(self, b)
...
def GWLPmixed(al, verbose=0, truncate=1):
    ...
    std::vector<double> GWLPmixed(const
    array_link &al, int verbose=0, int truncate=1) 
    """
...
def arrayrankColPiv(al):
    """
    arrayrankColPiv(array_link al) -> int

    int arrayrankColPiv(const
    array_link &al)

    return rank of an array based on Eigen::ColPivHouseholderQR 
    """
    return _oalib.arrayrankColPiv(al)
...
class rankStructure(object):
    ...
    def __init__(self, *args):
        ...
        rankStructure::rankStructure(int nsub=3)
    ...
    def matrixP(self):
        """
        matrixP(rankStructure self) -> Eigen::ColPivHouseholderQR< Eigen::MatrixXd >::PermutationType

        Eigen::ColPivHouseholderQR<Eigen::MatrixXd>::PermutationType
...
def addArraysToPareto(pset, paretofunction, arraylist, jj, verbose):
    ...
    return _oalib.addArraysToPareto(pset, paretofunction, arraylist, jj, verbose)
class jindex_t(object):
    """Proxy of C++ jindex_t class"""
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    k = _swig_property(_oalib.jindex_t_k_get, _oalib.jindex_t_k_set)
    j = _swig_property(_oalib.jindex_t_j_get, _oalib.jindex_t_j_set)

    def __init__(self, k_, j_):
        """__init__(jindex_t self, int k_, int j_) -> jindex_t"""
        this = _oalib.new_jindex_t(k_, j_)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class conference_t(object):
    ...
    def __init__(self, *args):
        """
        __init__(conference_t self, int N, int k) -> conference_t
...
class CandidateGenerator(object):
    """Proxy of C++ CandidateGenerator class"""
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    ct = _swig_property(_oalib.CandidateGenerator_ct_get, _oalib.CandidateGenerator_ct_set)
    verbose = _swig_property(_oalib.CandidateGenerator_verbose_get, _oalib.CandidateGenerator_verbose_set)
    cande = _swig_property(_oalib.CandidateGenerator_cande_get, _oalib.CandidateGenerator_cande_set)
    alz = _swig_property(_oalib.CandidateGenerator_alz_get, _oalib.CandidateGenerator_alz_set)

    def __init__(self, al, ct):
        """__init__(CandidateGenerator self, array_link al, conference_t ct) -> CandidateGenerator"""
        this = _oalib.new_CandidateGenerator(al, ct)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def generateConfCandidates(self, al, kz):
        """generateConfCandidates(CandidateGenerator self, array_link al, int kz) -> cpermVector"""
        return _oalib.CandidateGenerator_generateConfCandidates(self, al, kz)


    def showCandidates(self):
        """showCandidates(CandidateGenerator self)"""
        return _oalib.CandidateGenerator_showCandidates(self)


    def updateLastValid(self, lv):
        """updateLastValid(CandidateGenerator self, int lv)"""
        return _oalib.CandidateGenerator_updateLastValid(self, lv)

    __swig_destroy__ = _oalib.delete_CandidateGenerator
    __del__ = lambda self: None
CandidateGenerator_swigregister = _oalib.CandidateGenerator_swigregister
CandidateGenerator_swigregister(CandidateGenerator)

class CandidateGeneratorDouble(object):
    """Proxy of C++ CandidateGeneratorDouble class"""
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    ct = _swig_property(_oalib.CandidateGeneratorDouble_ct_get, _oalib.CandidateGeneratorDouble_ct_set)
    verbose = _swig_property(_oalib.CandidateGeneratorDouble_verbose_get, _oalib.CandidateGeneratorDouble_verbose_set)
    al = _swig_property(_oalib.CandidateGeneratorDouble_al_get, _oalib.CandidateGeneratorDouble_al_set)
    last_valid = _swig_property(_oalib.CandidateGeneratorDouble_last_valid_get, _oalib.CandidateGeneratorDouble_last_valid_set)
    ...
    def generateDoubleConfCandidates(self, al):
        """generateDoubleConfCandidates(CandidateGeneratorDouble self, array_link al) -> cpermVector"""
        return _oalib.CandidateGeneratorDouble_generateDoubleConfCandidates(self, al)


    def showCandidates(self):
        """showCandidates(CandidateGeneratorDouble self)"""
        return _oalib.CandidateGeneratorDouble_showCandidates(self)

    START_COL = _oalib.CandidateGeneratorDouble_START_COL
...
def extend_conference_matrix_generator(al, ct, extcol, verbose, maxzpos, cgenerator):
    """extend_conference_matrix_generator(array_link al, conference_t ct, int extcol, int verbose, int maxzpos, CandidateGenerator cgenerator) -> conference_extend_t"""
...
def generateConferenceExtensions(al, ct, kz, verbose=1, filtersymm=1, filterip=1):
    """
    generateConferenceExtensions(array_link al, conference_t ct, int kz, int verbose=1, int filtersymm=1, int filterip=1) -> cpermVector
    ...
    """
    return _oalib.generateConferenceExtensions(al, ct, kz, verbose, filtersymm, filterip)
...
class DconferenceFilter(object):
    """Proxy of C++ DconferenceFilter class"""
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
...
class ParetoLong(object):
    ...
    def addvalue(self, val, idx):
        """
        addvalue(ParetoLong self, mvalueVector val, long idx) -> bool
...
class ParetoMLong(object):
    ...
    def addvalue(self, val, idx):
        """
        addvalue(ParetoMLong self, mvalueVector val, long idx) -> bool
...
class ParetoDoubleLong(object):
    ...
    def addvalue(self, val, idx):
        """
        addvalue(ParetoDoubleLong self, doubleVector val, long idx) -> bool
