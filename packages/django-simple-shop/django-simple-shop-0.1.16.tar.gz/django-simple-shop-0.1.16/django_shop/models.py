    ...
    def send_emails(self):
        ...
        if self.state == self.STATE_CREATED:
            self._send_customer_mail(
                'django_shop/email/order_cash_customer_email.txt')
            self._send_manager_mail(
                'django_shop/email/order_cash_manager_email.txt')
        elif self.state == self.STATE_NC_PAID:
            self._send_customer_mail(
                'django_shop/email/order_nc_customer_email.txt')
            self._send_manager_mail(
                'django_shop/email/order_nc_manager_email.txt')
