...
The provided extension class 'epyunit.spUnit.TestProcesss' extends the standard class
...
::
    ...
    automation for               | epyunit.spUnit.TestProcesss |   <--->   |  epyunit.PyDevERDbg.PyDevERDbg    |
...
blackbox testing of calls of arbitrary
subprocesses and the integrated seamless debugging into subprocesses.
