...
class TestFibonacci(OnyxTestCase):
    ...
    def test_graph(self):
        ...
        node_8_parents = {('fib', 'fib', (9,)), ('fib', 'fib', (10,))}
        node_8_children = {('fib', 'fib', (6,)), ('fib', 'fib', (7,))}
        node_8 = GetNode(self.name, "fib", (8,))

        self.assertTrue(node_8.valid)
        self.assertEqual(node_8.value, 21)
        self.assertEqual(node_8.parents, node_8_parents)
        self.assertEqual(node_8.children, node_8_children)
