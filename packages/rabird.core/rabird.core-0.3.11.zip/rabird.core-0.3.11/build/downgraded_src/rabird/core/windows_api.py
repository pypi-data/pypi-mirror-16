...
class SHELLEXECUTEINFO(ctypes.Structure):
    _fields_ = (
        (u"cbSize", ctypes.wintypes.DWORD),
        (u"fMask", ctypes.c_ulong),
        (u"hwnd", ctypes.wintypes.HANDLE),
        (u"lpVerb", ctypes.c_wchar_p),
        (u"lpFile", ctypes.c_wchar_p),
        (u"lpParameters", ctypes.c_wchar_p),
        (u"lpDirectory", ctypes.c_wchar_p),
        (u"nShow", ctypes.c_int),
        (u"hInstApp", ctypes.wintypes.HINSTANCE),
        (u"lpIDList", ctypes.c_void_p),
        (u"lpClass", ctypes.c_wchar_p),
        (u"hKeyClass", ctypes.wintypes.HKEY),
        (u"dwHotKey", ctypes.wintypes.DWORD),
        (u"hIconOrMonitor", ctypes.wintypes.HANDLE),
        (u"hProcess", ctypes.wintypes.HANDLE),
    )
