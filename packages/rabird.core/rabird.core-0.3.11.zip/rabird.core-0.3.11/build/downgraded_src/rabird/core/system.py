...
logger = __import__(u'logging').getLogger(u'rabird.core.system')
...
def whereis_win32(file_name):
    ...
    pathexts = os.environ[u"PATHEXT"].split(os.pathsep)
    original_paths = os.environ[u"PATH"].split(os.pathsep)
