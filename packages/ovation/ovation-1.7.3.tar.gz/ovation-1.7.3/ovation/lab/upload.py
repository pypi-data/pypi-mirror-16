...
def upload_resource(session, entity_id, local_path, resource_group=None, progress=tqdm):
    """
    ...
    upload._upload_to_aws(aws, content_type, local_path, progress)

    return r


def upload_resource_group(session, activity, local_directory_path, progress=tqdm):
    """
    ...
    for root, dirs, files in os.walk(local_directory_path):
        ...
        for f in files:
            ...
            upload_resource(session, activity, path, resource_group=resource_group, progress=progress)
