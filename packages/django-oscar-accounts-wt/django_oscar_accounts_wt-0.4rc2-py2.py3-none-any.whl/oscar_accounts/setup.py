...
#    licenses = AccountType.add_root(name='Licenses')
#    fullaccess_lic = licenses.add_child(name='Full Access license')
#    partialaccess_lic = licenses.add_child(name='Partial Access license')
#    gift_lic = licenses.add_child(name='Gift Access license')
