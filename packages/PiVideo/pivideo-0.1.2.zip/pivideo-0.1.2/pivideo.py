...
def main():
	...
	parser = argparse.ArgumentParser(description='PiVideo control program version 0.1.2    Lintest Systems LLC')
		...
		print("  Video Processor was not found - please check your switches and settings")
                ...
                if (args.getserial==1):
                        try:
                                ...
                                pass
                                print("  Unable to stop/disable serial getty - did you use sudo?")
