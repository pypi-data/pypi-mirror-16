...
.. proof:proof::
    ...
    Il suffit de reprendre l'ensemble des égalités du premier bilan, en utilisant le fait que :math:`s=c` et :math:`n=a`.
...
.. proof:proof::
  ...
  La première égalité découle de la formule :math:`n(n-1)=c-1` prouvée précédemment.
...
.. proof:property::
   ...
   Pour tout entier :math:`k\geq 2`, la configuration générée par l'algorithme est valide. De plus, elle est :
...
.. proof:property::
   ...
   Soit :math:`\Delta_k` la configuration générée par l'algorithme pour un certain entier :math:`k\geq 2`, et :math:`\Delta_k^*` sa configuration duale. Alors, en identifiant :
