...
<http://git.framasoft.org/spalax/jouets>`_ pour les instructions, et le
`changelog <https://git.framasoft.org/spalax/jouets/blob/master/CHANGELOG.md>`_.
...
.. [#f1] …ou du moins, si un des algorithmes n'est pas de moi, ça n'est pas consient. En particulier :
