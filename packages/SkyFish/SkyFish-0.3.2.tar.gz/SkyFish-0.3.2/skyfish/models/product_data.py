...
class ProductData(object):
    ...
    def __init__(self, json_dictionary):
        ...
        if not type(self.sku) is str:
            raise TypeError('`sku` property should be str')
        ...
        for item in self.payment_types:
            if not type(item) is str:
                raise TypeError('payment type should be str')
        ...
        for item in self.image_url:
            if not type(item) is str:
                raise TypeError('image url location should be str')
        ...
        if not type(self.insurance_type) is str:
            raise TypeError('`insurance_type` property should be str')
        ...
        if not type(self.environment_type) is str:
            raise TypeError('`environment_type` property should be str')
