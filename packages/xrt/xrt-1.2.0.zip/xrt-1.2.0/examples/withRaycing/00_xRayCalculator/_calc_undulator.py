...
source = rs.Undulator(eE=3.0, eI=0.5, eEpsilonX=0.263, eEpsilonZ=0.008,
                      betaX=9.539, betaZ=1.982, period=18.5, n=108, K=1.92,
                      distE='BW')
energy = np.linspace(11000, 12000, 1001)
...
spectraE, spectraF = np.loadtxt(
    "spectrum7.dc0", skiprows=10, usecols=(0, 1), unpack=True)
plt.plot(spectraE, spectraF, '-', lw=2)
