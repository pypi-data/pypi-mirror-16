...
* *Rays and waves*. Classical ray tracing and wave propagation
  via Kirchhoff integrals, also freely intermixed. No further approximations,
  such as thin lens or paraxial. The optical surfaces may have figure
  errors, analytical or measured. In wave propagation, partially
...
* *Synchrotron sources*. Bending magnet, wiggler,
  ...
  near field. Custom magnetic field is also possible. Undulators can be
  calculated on GPU, with a high gain in computation speed, which is important
  for tapering and near field calculations.
