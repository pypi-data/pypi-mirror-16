...
def mpi_map_code(func_code, x, params, procs, obj_dill=None):
    ...
    if len(x) > 0:
        ...
        if curr_pypath is None: curr_pypath = ''
        os.environ['PYTHONPATH'] = curr_pypath + ':' + os.getcwd()
        ...
        comm.bcast((obj_dill, func_code, params), root=MPI.ROOT)
        ...
        if curr_pypath == '':
            ...
            os.environ['PYTHONPATH'] = curr_pypath
    else:
        fval = []
