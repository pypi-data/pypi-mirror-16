...
# 100-turn Helmholtz coil on x-axis: measurements as-built
min_r = 75./2
max_r = 88./2
min_z = 34./2
max_z = 47./2
...
# add text
plot.labels(title = '"40mm" Helmholtz Coil\n(as-built measurements, 200-loop model)',
            xlabel = 'x (mm)', ylabel = 'y (mm)')

# save plot
plot.save('helmholtz_as_built_200t.png')
