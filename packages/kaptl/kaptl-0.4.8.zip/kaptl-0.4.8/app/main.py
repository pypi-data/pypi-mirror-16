...
"""Usage: kaptl init <name> [--backend=mvc] [--frontend=angular] [<rules> | --rules-file=RULESFILE ] [--build] [--recipe=RECIPENAME] --license=KEY
       kaptl parse <rules> --license=KEY [--recipe=RECIPENAME]
       kaptl update [--build] --license=KEY [--recipe=RECIPENAME]
