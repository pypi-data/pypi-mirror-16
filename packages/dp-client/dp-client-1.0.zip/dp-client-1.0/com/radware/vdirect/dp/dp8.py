...
class DP8Meta(object):
    def __init__(self):
        ...
        self.rdwrDPClustering = self.RdwrDPClustering()
        ...
        self.rsBWMActiveSecGrpTag = self.RsBWMActiveSecGrpTag()
        ...
        self.rsBWMModifySecGrpTag = self.RsBWMModifySecGrpTag()
        ...
        self.rsClusteringEntry = self.RsClusteringEntry()
    ...
    class RdwrDPClustering:
        def __init__(self):
            self.rsClusteringMaster = 'rsClusteringMaster'
            self.rsClusteringState = 'rsClusteringState'
            self.rsClusteringChannelIp = 'rsClusteringChannelIp'
            self.rsClusteringChannelGw = 'rsClusteringChannelGw'
            self.rsClusteringChannelMask = 'rsClusteringChannelMask'

        def __call__(self):
            return 'RdwrDPClustering'
    ...
    class RndDeviceParams:
        def __init__(self):
            ...
            self.rsCoresNumber = 'rsCoresNumber'
            self.rsCPUFrequency = 'rsCPUFrequency'
    ...
    class RdwrDP:
        def __init__(self):
            ...
            self.mitigationSwitchMode = 'mitigationSwitchMode'
    ...
    class RsIDSSynProfilesParamsEntry:
        def __init__(self):
            ...
            self.status = 'status'
            self.sSLMitigationStatus = 'sSLMitigationStatus'
            self.name = 'name'
    ...
    class RsExportPolicyEntry:
        def __init__(self):
            ...
            self.sigUserProfile = 'sigUserProfile'
            self.name = 'name'
    ...
    class RsServerDispatcher:
        def __init__(self):
            ...
            self.rsWSDThroughputLicenseIP = 'rsWSDThroughputLicenseIP'
            self.rsWSDThroughputLicenseMethod = 'rsWSDThroughputLicenseMethod'
            ...
            self.rsFormFactor = 'rsFormFactor'
            self.rsAppAgPort = 'rsAppAgPort'
            self.rsAppAgIpAddress = 'rsAppAgIpAddress'
            self.rsAppAgInstId = 'rsAppAgInstId'
            self.rsAppAGChannelIp = 'rsAppAGChannelIp'
            self.rsAppAGChannelMask = 'rsAppAGChannelMask'
            self.rsAppAGChannelGw = 'rsAppAGChannelGw'

        def __call__(self):
            return 'RsServerDispatcher'

    class RsBWMActiveSecGrpTag:
        def __init__(self):
            self.bWMSecGroupEntryActiveValue = 'bWMSecGroupEntryActiveValue'
            self.bWMSecGroupActiveEntryName = 'bWMSecGroupActiveEntryName'

        def __call__(self):
            return 'RsBWMActiveSecGrpTag'
    ...
    class RsBWMModifySecGrpTag:
        def __init__(self):
            self.bWMSecGroupEntryValue = 'bWMSecGroupEntryValue'
            self.bWMSecGroupEntryStatus = 'bWMSecGroupEntryStatus'
            self.bWMSecGroupEntryRowStatus = 'bWMSecGroupEntryRowStatus'
            self.bWMSecGroupEntryName = 'bWMSecGroupEntryName'

        def __call__(self):
            return 'RsBWMModifySecGrpTag'
    ...
    class RsClusteringEntry:
        def __init__(self):
            self.clusterEntState = 'clusterEntState'
            self.clusterEntAddr = 'clusterEntAddr'

        def __call__(self):
            return 'RsClusteringEntry'
    ...
    class RsImportBaselineDnsEntry:
        def __init__(self):
            ...
            self.mxInPpsIpv4 = 'mxInPpsIpv4'
            self.mxOutPpsIpv4 = 'mxOutPpsIpv4'
            self.ptrInPpsIpv4 = 'ptrInPpsIpv4'
            self.ptrOutPpsIpv4 = 'ptrOutPpsIpv4'
            self.aaaaInPpsIpv4 = 'aaaaInPpsIpv4'
            self.aaaaOutPpsIpv4 = 'aaaaOutPpsIpv4'
            self.textInPpsIpv4 = 'textInPpsIpv4'
            self.textOutPpsIpv4 = 'textOutPpsIpv4'
            self.soaInPpsIpv4 = 'soaInPpsIpv4'
            self.soaOutPpsIpv4 = 'soaOutPpsIpv4'
            self.naptrInPpsIpv4 = 'naptrInPpsIpv4'
            self.naptrOutPpsIpv4 = 'naptrOutPpsIpv4'
            self.srcInPpsIpv4 = 'srcInPpsIpv4'
            self.srcOutPpsIpv4 = 'srcOutPpsIpv4'
            self.otherInPpsIpv4 = 'otherInPpsIpv4'
            self.otherOutPpsIpv4 = 'otherOutPpsIpv4'
            self.aInPpsIpv4 = 'aInPpsIpv4'
            self.aOutPpsIpv4 = 'aOutPpsIpv4'
            self.mxInPpsIpv6 = 'mxInPpsIpv6'
            self.mxOutPpsIpv6 = 'mxOutPpsIpv6'
            self.ptrInPpsIpv6 = 'ptrInPpsIpv6'
            self.ptrOutPpsIpv6 = 'ptrOutPpsIpv6'
            self.aaaaInPpsIpv6 = 'aaaaInPpsIpv6'
            self.aaaaOutPpsIpv6 = 'aaaaOutPpsIpv6'
            self.textInPpsIpv6 = 'textInPpsIpv6'
            self.textOutPpsIpv6 = 'textOutPpsIpv6'
            self.soaInPpsIpv6 = 'soaInPpsIpv6'
            self.soaOutPpsIpv6 = 'soaOutPpsIpv6'
            self.naptrInPpsIpv6 = 'naptrInPpsIpv6'
            self.naptrOutPpsIpv6 = 'naptrOutPpsIpv6'
            self.srcInPpsIpv6 = 'srcInPpsIpv6'
            self.srcOutPpsIpv6 = 'srcOutPpsIpv6'
            self.otherInPpsIpv6 = 'otherInPpsIpv6'
            self.otherOutPpsIpv6 = 'otherOutPpsIpv6'
            self.aInPpsIpv6 = 'aInPpsIpv6'
            self.aOutPpsIpv6 = 'aOutPpsIpv6'
            self.name = 'name'
    ...
    class RsIDSSynProtection:
        def __init__(self):
            ...
            self.rsIDSynSSLMitigationAlteonMac = 'rsIDSynSSLMitigationAlteonMac'
    ...
    class RsGeneric:
        def __init__(self):
            ...
            self.rsDebugSnapshotPortGroup = 'rsDebugSnapshotPortGroup'
