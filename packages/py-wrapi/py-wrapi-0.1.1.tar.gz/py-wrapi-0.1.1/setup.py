...
setup(
    ...
    description='A bunch of API wrappers for Python',
    long_description=readme,
    author=get_author(package),
    author_email=get_email(package),
    url='https://github.com/thisisandreeeee/py-wrapi',
    download_url='https://github.com/thisisandreeeee/py-wrapi/tarball/0.1',
    packages=[
        'py_wrapi'
    ],
    package_dir={'py_wrapi': 'py_wrapi'},
    include_package_data=True,
    install_requires=requirements,
    license="MIT",
    zip_safe=False,
    keywords=['sently','api','wrapper'],
    classifiers=[
