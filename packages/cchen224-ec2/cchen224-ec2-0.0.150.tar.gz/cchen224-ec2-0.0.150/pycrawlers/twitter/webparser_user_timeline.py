...
def parse_user_timeline(screen_name, **kwargs):
    ...
    while has_next:
        ...
        tweet_cardwraps = soup.find_all('li', class_='js-stream-item stream-item stream-item ')
        if len(tweet_cardwraps) == 0:
            break

        # tweet_cardwrap = tweet_cardwraps[2]
