...
static PyObject *const_str_digest_4454379ebb1b4c0ff0003a43e591a21b;
...
{
    const_str_digest_4454379ebb1b4c0ff0003a43e591a21b = UNSTREAM_STRING( &constant_bin[ 1206744 ], 16, 0 );
...
static PyCodeObject *codeobj_094b7ea6671086fd8013f4ecceadcb1f;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_4454379ebb1b4c0ff0003a43e591a21b );
    codeobj_094b7ea6671086fd8013f4ecceadcb1f = MAKE_CODEOBJ( module_filename_obj, const_str_plain_client, 1, const_tuple_empty, 0, CO_NOFREE | CO_FUTURE_ABSOLUTE_IMPORT );
}
...
MOD_INIT_DECL( xmlrpc$client )
{
    ...
    moduledict_xmlrpc$client = (PyDictObject *)((PyModuleObject *)module_xmlrpc$client)->md_dict;
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    PyObject *module_dict = PyModule_GetDict( module_xmlrpc$client );
    ...
    UPDATE_STRING_DICT0( moduledict_xmlrpc$client, (Nuitka_StringObject *)const_str_plain_absolute_import, tmp_assign_source_3 );
    // Frame without reuse.
    frame_module = MAKE_MODULE_FRAME( codeobj_094b7ea6671086fd8013f4ecceadcb1f, module_xmlrpc$client );
    ...
    // Framed code:
    tmp_import_globals_1 = ((PyModuleObject *)module_xmlrpc$client)->md_dict;
    ...
    UPDATE_STRING_DICT1( moduledict_xmlrpc$client, (Nuitka_StringObject *)const_str_plain_sys, tmp_assign_source_4 );
    ...
    goto frame_exception_exit_1;
    branch_no_1:;
    tmp_import_globals_2 = ((PyModuleObject *)module_xmlrpc$client)->md_dict;
    ...
    tmp_result = IMPORT_MODULE_STAR( module_xmlrpc$client, true, tmp_star_imported_1 );
