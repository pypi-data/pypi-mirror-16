...
static auto s_enter = bob::extension::FunctionDoc(
  "__enter__",
  "ENTER",
  "ENTER",
  true
...
.add_prototype("")
;
static PyObject* PyBobIoHDF5File_enter(PyBobIoHDF5FileObject* self, PyObject *args, PyObject* kwds) {
BOB_TRY
  /* Parses input arguments in a single shot */
  return Py_BuildValue("N",self);
  
  
BOB_CATCH_MEMBER(exception_message(self, s_enter.name()).c_str(), 0);
}



static auto s_exit = bob::extension::FunctionDoc(
  "__exit__",
  "EXIT",
  "EXIT",
  true
...
.add_prototype("")
;
static PyObject* PyBobIoHDF5File_exit(PyBobIoHDF5FileObject* self, PyObject *args, PyObject* kwds) {
BOB_TRY
  /* Parses input arguments in a single shot */
  ...
  Py_RETURN_NONE;
BOB_CATCH_MEMBER(exception_message(self, s_exit.name()).c_str(), 0);
}
...
static PyMethodDef PyBobIoHDF5File_methods[] = {
  ...
  {
    s_enter.name(),
    (PyCFunction)PyBobIoHDF5File_enter,
    METH_NOARGS,
    s_enter.doc()
  },
  ...
  {
    s_exit.name(),
    (PyCFunction)PyBobIoHDF5File_exit,
    METH_VARARGS,
    s_exit.doc()
  },
