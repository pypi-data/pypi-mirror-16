...
class Monitor:
    ...
    def __init__(self, nodes, time_interval=1, init_time=3, result_handler=None, plugins=[], interlogin_time=0, max_nodes=1, skip_install=False):
        """
        ...
        :param skip_install: if set, this skips the installation of packages
        """
        ...
        for node in nodes:
            ...
            if node_info['enabled']:
                ...
                thread = MonitorThread(node, nodes, init_time, time_interval, result_handler, plugins, skip_install)
...
class MonitorThread(threading.Thread):
    ...
    def __init__(self, node, nodes, init_time, time_interval, result_handler, plugins, skip_install):
        """
        Creating threads.
        ...
        :param skip_install: whether or not to skip installations
        """
