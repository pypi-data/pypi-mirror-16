...
def parse_args(args):
    ...
    parser.add_argument(
        ...
        '--skip-install',
        dest="skip_install",
        help="Skips installation of packages",
        action="store_true",
        default=False
    )
...
def main(args):
    ...
    monitor = Monitor(nodes, args.interval, args.timeout, output_handler.process, plugins, args.interlogin, args.max_nodes, args.skip_install)
    monitor.run()
