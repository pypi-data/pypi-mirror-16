...
class TestImageSenderService(object):
    ...
    """
    ur"^/img (http(s)?://|www.)[^;>\| ]+(.png|.jpg)$"
    correct_messages = [u"/img http://www.google.com/image.jpg", u"/img https://google.com/image.png",
                        u"/img www.google.com/image.png"]
    incorrect_messages = [u"/img www.goog|e.com/image.png", u"/img www.image.png",
                          u"/img http://goo gle.com/image.png", u"/img www.google;.com/image.png",
                          u"/img www.google.com/image.exe", u"img /home/homedir.png"]
