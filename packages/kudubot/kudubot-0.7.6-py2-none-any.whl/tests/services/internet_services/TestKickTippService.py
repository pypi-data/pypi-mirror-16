...
class TestKickTippService(object):
    ...
    correct_messages = [u"/kicktipp kickers", u"/kicktipp xyz-community"]
    incorrect_messages = [u"---/kicktipp kickers", u"/kicktipp kicker-community---", u"/kicktipp xyz community"]
