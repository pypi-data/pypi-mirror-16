...
class ForwardedWhatsappConnection(WhatsappConnection):
    ...
    def initialize(self):
        ...
        :return: None
        """
        super(ForwardedWhatsappConnection, self).initialize()
    ...
    def establish_connection():
        ...
        def start_connection():
            ...
            while True:
                try:
                    PrintLogger.print(u"Starting Whatsapp Forwarding Connection", 1)
                    echo_stack = YowsupEchoStack(ForwardedWhatsappConnection, credentials)
                    echo_stack.start()
                except Exception, e:
                    stack_trace = traceback.format_exc()
                    ExceptionLogger.log_exception(e, stack_trace, u"whatsapp Forwarder")
