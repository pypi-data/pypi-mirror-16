...
class Service(object):
    ...
    help_description = {u"en": u"A Generic Service Interface",
                        u"de": u"Eine Generische Dienstleistungsschnittstelle"}
    u"""
    ...
    def send_text_as_image_message(self, message):
        u"""
        ...
        :return: None
        """
        image_file_path = os.path.join(LocalConfigChecker.program_directory, u"temp_text_image.png")
        ...
        padding = (2, 2)
        fontsize = 30
        font_file = get_font(u"NotCourierSans.otf")
        font = ImageFont.truetype(font_file, fontsize)

        image_size_test = Image.new(u"RGBA", (0, 0), (255, 255, 255))
        ...
        image = Image.new(u"RGBA", (width, height), (255, 255, 255))
    ...
    @staticmethod
    def generate_reply_message(message, title, body):
        u"""
    ...
    @staticmethod
    def regex_string_from_dictionary_keys(dictionaries):
        u"""
    ...
    @staticmethod
    def delete_file_after(file_path, after_seconds):
        u"""
    ...
    @staticmethod
    def wait_until_delete(file_path, time_out):
        u"""
