...
class TestEmailSenderService(object):
    ...
    correct_messages = [u"/email \"Test\" user@domain.tld", u"/email \"Test\" \"Title\" user@domain.tld",
                        u"/email \"Test Message\" user@domain.tld", u"/email \"Te st\" \"Title Test\" user@domain.tld",
                        u"/email \"@#$%^&*(&^%*&úüéð®fëfðfëáfå,,w,e,d,d,...asdsd    e.. . .dfdaasdsad\" user@domain.tld"]
    incorrect_messages = [u"---/email \"test\" user@domain.com", u"/email \"test\" user@domain.com---", u"/email",
                          u"/email \"tes\"t message\" user@domain.tld", u"/email \"tes\"t \"mes\"sage\" user@domain.tld"]
