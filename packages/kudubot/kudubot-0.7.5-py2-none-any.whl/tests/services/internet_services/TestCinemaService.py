...
class TestCinemaService(object):
    ...
    correct_messages = [u"/cinema karlsruhe", u"/cinema karlsruhe 10", u"/cinema new york city 20", u"/cinema cape town",
                        u"/kino place"]
    incorrect_messages = [u"/cinem karlsruhe", u"/cinema karlsruhe -1", u"balaalal/cinema karlsruhe shjsncksjsaax",
                          u"balaalal/cinema karlsruhe---------"]
