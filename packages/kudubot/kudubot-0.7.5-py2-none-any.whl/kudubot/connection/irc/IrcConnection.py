...
class IrcConnection(irc.bot.SingleServerIRCBot, Connection):
    ...
    def __init__(self, credentials):
        ...
        :return: None
        """
        super(IrcConnection, self).__init__([(credentials[1], int(credentials[3]))], credentials[0], credentials[0])
    ...
    def on_pubmsg(self, connection, event):
        ...
        message = Message(message_body=received_text, message_title=u"", address=self.channel, incoming=True,
    ...
    def on_privmsg(self, connection, event):
        ...
        message = Message(message_body=received_text, message_title=u"", address=sender_name, incoming=True,
    ...
    def send_text_message(self, message):
        ...
        for line in message.message_body.split(u"\n"):
    ...
    def establish_connection():
        ...
        while True:
            ...
            PrintLogger.print(u"Starting IRC connection", 1)
            bot.start()
