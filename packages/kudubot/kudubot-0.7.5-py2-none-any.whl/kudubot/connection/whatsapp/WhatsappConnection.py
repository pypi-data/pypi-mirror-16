...
class WhatsappConnection(YowsupEchoLayer, Connection):
    ...
    def __init__(self):
        ...
        :return: None
        """
        super(WhatsappConnection, self).__init__()
    ...
    def establish_connection():
        ...
        while True:
            try:
                PrintLogger.print(u"Starting Whatsapp Connection", 1)
                echo_stack = YowsupEchoStack(WhatsappConnection, credentials)
                echo_stack.start()
            except Exception, e:
                stack_trace = traceback.format_exc()
                ExceptionLogger.log_exception(e, stack_trace, u"whatsapp")
    ...
    @staticmethod
    def convert_text_message_protocol_entity_to_message(message_protocol_entity):
        u"""
