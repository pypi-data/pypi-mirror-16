...
class Authenticator(object):
    ...
    def __init__(self, connection_type):
        ...
        :return: None
        """
        self.admin_contact_file = os.path.join(LocalConfigChecker.contacts_directory, connection_type, u"admin")
        self.blacklisted_contact_file = \
            os.path.join(LocalConfigChecker.contacts_directory, connection_type, u"blacklist")

    @staticmethod
    def is_in_file(user, contact_file):
        u"""
        ...
        """
        contacts = open(contact_file, u'r')
        content = contacts.read()
        contacts.close()

        return user in content.split(u"\n")
    ...
    def is_from_blacklisted_user(self, message):
        u"""
