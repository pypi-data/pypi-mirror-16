...
from test_listener.queues.outgoing import OutgoingMessageQueue
...
class TestListener(object):
    ...
    def __init__(self, customer_id, app_name, build, branch, env):
        self.outgoing_queue = OutgoingMessageQueue(customer_id, app_name, build, branch, env)
    ...
    #
    # def example_finished(self, notification):
    #     StateTracker().current_test_identifier = None
