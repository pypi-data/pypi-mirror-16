...
class SerializerExporter:
    ...
    def get_fields_for_model(self, model, serializer_instance):
        ...
        for field_name, field in serializer_instance.get_fields().items():
            ...
            if isinstance(field, PrimaryKeyRelatedField) or isinstance(field, ManyRelatedField):
                ...
                field_item['related_model'] = model_field.related_model._meta.verbose_name
                field_item['app'] = model_field.related_model._meta.app_label.lower()
