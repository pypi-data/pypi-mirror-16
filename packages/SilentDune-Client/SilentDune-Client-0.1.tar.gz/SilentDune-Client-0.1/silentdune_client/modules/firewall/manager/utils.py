...
from silentdune_client.modules.firewall.manager.iptables_utils import create_iptables_generic_dns_egress_rules, create_iptables_generic_ntp_egress_rules
