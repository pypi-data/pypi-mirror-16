...
class SilentDuneClientLoggingModule(BaseModule):
    ...
    def add_installer_arguments(self, parser):
        ...
        group.add_argument('--logging-mod-enable', action='store_false',  # noqa
    ...
    def validate_arguments(self, args):
        ...
        if (not '--logging-mod-enable' in sys.argv) and (
                    '--logging-limit-rate' in sys.argv):
            print('sdc-install: argument --logging-mod-enable conflicts with other logging module arguments.')
            return False
