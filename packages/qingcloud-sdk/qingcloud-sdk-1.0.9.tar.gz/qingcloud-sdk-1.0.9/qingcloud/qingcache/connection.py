...
from qingcloud.conn.auth import QCacheSignatureAuthHandler
...
class QCacheConnection(HttpConnection):
    ...
    def __init__(self, qy_access_key_id=None, qy_secret_access_key=None,
        ...
        super(QCacheConnection, self).__init__(
        ...
        if qy_access_key_id and qy_secret_access_key:
            self._auth_handler = QCacheSignatureAuthHandler(host, qy_access_key_id,
    ...
    def create_bucket(self, bucket, zone):
        """ Create a new bucket.
