...
project_url = u"http://namibsun.net/namboy94/tok-tokkie"
u"""
A URL linking to the home page of the project, in this case a
self-hosted Gitlab page
"""

download_url = u"http://gitlab.namibsun.net/namboy94/tok-tokkie/repository/archive.zip?ref=master"
u"""
...
python3_requirements = [u'tvdb_api', u'beautifulsoup4', u'gfworks', u'typing', u'irc', u'puffotter']
u"""
Python 3 Python Packaging Index requirements
"""

python2_requirements = [u'tvdb_api', u'beautifulsoup4', u'gfworks_2', u'typing', u'irc', u'puffotter_2']
u"""
...
programming_language = u'Programming Language :: Python :: 3'
u"""
