...
from .mixins import AdminAccessMixin, DashboardAccessMixin
...
class Dashboard(AdminAccessMixin, TemplateView):
    """
...
class AccountList(AdminAccessMixin, ListView):
    """
...
class Profile(AdminAccessMixin, DetailView):
    """
...
class RemoveFilter(AdminAccessMixin, View):
    """
...
class ReportList(AdminAccessMixin, ListView):
    """
...
class ReportListAjax(AdminAccessMixin, View):
    """
...
class TopAccounts(AdminAccessMixin, View):
    """
...
class ReportsReleased(AdminAccessMixin, View):
    """
...
class DashboardAverage(AdminAccessMixin, View):
    """
...
class ExportReports(AdminAccessMixin, View):
    """
