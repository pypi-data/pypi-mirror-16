...
LONG_DESCRIPTION = 'This is the Emrys flavor of jupyterlab.'
...
setup_args = {
    ...
    'description': 'An Emrys flavored Jupyter lab environment notebook server extension.',
    ...
    'author': 'Emrys Dev Team',
    'author_email': 'peter@projectemrys.com',
    'url': 'http://projectemrys.com',
    'keywords': ['ipython', 'jupyter', 'Web', 'emrys'],
    'classifiers': [
