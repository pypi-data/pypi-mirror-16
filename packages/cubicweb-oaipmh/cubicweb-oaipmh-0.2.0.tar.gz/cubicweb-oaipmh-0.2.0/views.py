...
class OAIListRecordsErrorView(OAIView):
    ...
    def errors(self):
        return {
            'badArgument': ('ListRecords verb requires "set" and '
                            '"metadataPrefix" restrictions')}


class OAIListRecordsMissingSetView(OAIView):
    """View handling verb="ListRecords" requests missing "set" restriction.
    """
...
class OAIListRecordsMissingMetadataPrefixView(OAIView):
    """View handling verb="ListRecords" requests missing "metadataPrefix"
    restriction.
    """
    __select__ = match_verb('ListRecords') & match_form_params('set')

    def errors(self):
        return {
            'badArgument': 'ListRecords verb requires "metadataPrefix" restriction'}


class OAIListRecordsView(OAIView):
    """View handling verb="ListRecords" requests with "set" and
    "metadataPrefix" selection.
    """
    __select__ = (match_verb('ListRecords')
                  & match_form_params('set', 'metadataPrefix'))
