...
class OAIPMHViewsTC(CubicWebTC, OAITestMixin):
    ...
    def test_listrecords_noargument(self):
        ...
        expected = (
            ...
            'ListRecords verb requires "set" and "metadataPrefix" restrictions'
            '</error>'
        )
    ...
    def test_listrecords_noset(self):
        with self.admin_access.web_request() as req:
            result = self.oai_request(req, verb='ListRecords', metadataPrefix='blop')
        expected = (
            '<error code="badArgument">'
    ...
    def test_listrecords_nometadataprefix(self):
        with self.admin_access.web_request() as req:
            result = self.oai_request(req, verb='ListRecords', set='blop')
        expected = (
            '<error code="badArgument">'
            'ListRecords verb requires "metadataPrefix" restriction'
            '</error>'
        )
        self.assertIn(expected, result)
