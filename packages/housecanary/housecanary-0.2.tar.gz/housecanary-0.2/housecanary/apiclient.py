...
class PropertyComponentWrapper(object):
    ...
    def _custom_internal(self, endpoint_name, address_data, components):
        """Internal method for custom endpoint aliases"""
        query_params = {"components": ",".join(components)}

        return self._fetch_property_component(endpoint_name, address_data, query_params)
    ...
    def component_mget(self, address_data, components):
        ...
        """
        return self._custom_internal("property/component_mget", address_data, components)

    def custom(self, address_data, components):
        """Call the custom endpoint, an alias for component_mget
        ...
        Args:
            ...
            - components - A list of strings for each component to include in the request.
                Example: ["property/details", "property/flood", "property/value"]
        """
        return self._custom_internal("property/custom", address_data, components)
