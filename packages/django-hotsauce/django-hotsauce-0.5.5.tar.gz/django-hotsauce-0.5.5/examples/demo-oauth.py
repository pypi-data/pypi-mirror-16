...
def main(app_label):
    ...
    google_client = client.GoogleClient(
        '51290408562-abs4t4ecqo834diltkk3d42cef6fi2sd.apps.googleusercontent.com', 
        access_token='d5RM8aoiHBET3Fu5kUBqwDGg', 
        scope='email', 
        redirect_url='http://localhost:8000/oauth2callback',
        login_path="/session_login/")

    wsgi_app = google_client.wsgi_middleware(wsgi_app, secret='hmac*secret')
