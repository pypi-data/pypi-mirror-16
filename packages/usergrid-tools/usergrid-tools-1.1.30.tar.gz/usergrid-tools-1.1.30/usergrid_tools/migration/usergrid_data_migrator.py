    ...
    def summarize(self, org_results):
        ...
        for app, app_data in org_results['apps'].iteritems():
            ...
            for collection, collection_data in app_data.get('collections', {}).iteritems():
                ...
                # APP
                if collection_data.get('iteration_finished') > app_iteration_finished:
                    app_iteration_finished = collection_data.get('iteration_finished')

                if collection_data.get('iteration_started') < app_iteration_started:
            ...
            # org
            if org_results['summary']['iteration_started'] > app_iteration_started:
                org_results['summary']['iteration_started'] = app_iteration_started

            if org_results['summary']['iteration_finished'] < app_iteration_finished:
