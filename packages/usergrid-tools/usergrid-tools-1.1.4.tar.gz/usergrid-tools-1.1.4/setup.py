...
setup(
        ...
        entry_points={
            'console_scripts': [
                ...
                'migration_request_listener = usergrid_tools.migration.migration_request_listener:main',
                'usergrid_data_migrator = usergrid_tools.migration.usergrid_data_migrator:main',
                'usergrid_data_migrator_2 = usergrid_tools.migration.usergrid_data_migrator_2:main',
