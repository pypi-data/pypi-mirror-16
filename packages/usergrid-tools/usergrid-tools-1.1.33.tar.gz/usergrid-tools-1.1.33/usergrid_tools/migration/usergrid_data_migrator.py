...
def on_migration_complete(params, status):
    ...
    Usergrid.init(org_id='usergrid',
                  app_id='migrator',
                  base_url='https://api-connectors-prod.apigee.net/appservices',
                  client_id=os.environ.get('BAAS_ID'),
                  client_secret=os.environ.get('BAAS_SECRET'))
