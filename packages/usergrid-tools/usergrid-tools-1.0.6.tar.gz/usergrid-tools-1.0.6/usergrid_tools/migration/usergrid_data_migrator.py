...
def log_queue_size(logger_, queue):
    if _platform == "linux" or _platform == "linux2":
        logger_.warn('CURRENT Queue Depth: %s' % queue.qsize())
            ...
            try:
                ...
                try:
                    for app, app_data in self.status['apps'].iteritems():
                        ...
                        log_queue_size(stauts_aggregator_logger, self.worker_queue)
...
def do_operation(apps_and_collections, operation):
    ...
    try:
        ...
        if collection_count > 0:
            ...
            log_queue_size(logger, collection_queue)
            ...
            log_queue_size(logger, entity_queue)
