...
if __name__ == "__main__":
    ...
    extensions = [setuptools.Extension("dummy_package.similarity_measure.cython_levenshtein",
                                       ["dummy_package/similarity_measure/cython_levenshtein.c"],
                                       include_dirs=[])]
    ...
    setuptools.setup(
        ...
        url='https://sites.google.com/site/anhaidgroup/projects/dummy_package',
