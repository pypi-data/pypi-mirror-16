...
import pyLuminous.incoherent_transfer_matrix as ITM
from scipy.interpolate import interp1d,splrep,splev
import pyLuminous.constants as C
c = C.c
pi = C.pi
from pyLuminous.transfer_matrix import LayerUniaxial,Layer
...
class PEOPTLayer(Layer):
    ...
    def __repr__(self):
        return "PEOPTLayer"+"("+repr(self.d)+", coh="+repr(self.coh)+" )"
...
class C60Layer(Layer):
    ...
    def __repr__(self):
        return "C60Layer"+"("+repr(self.d)+", coh="+repr(self.coh)+" )"
...
class PEDOTLayer(Layer):
    ...
    def __repr__(self):
        return "PEDOPTLayer"+"("+repr(self.d)+", coh="+repr(self.coh)+" )"
