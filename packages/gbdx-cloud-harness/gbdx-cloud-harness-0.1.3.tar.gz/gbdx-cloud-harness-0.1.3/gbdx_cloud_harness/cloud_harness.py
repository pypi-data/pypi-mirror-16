...
Usage:
    ...
    cloud-harness run <file_name> [--remote] [--verbose] [--upload] [--download]
...
class TaskController(object):
    ...
    def _run_app(self):
        ...
        """
        is_remote_run = self._arguments.get('--remote', None)
        filename = self._arguments.get('<file_name>', None)
        upload_ports = self._arguments.get('--upload', None)
        download_ports = self._arguments.get('--download', None)
        is_verbose = self._arguments.get('--verbose', None)
