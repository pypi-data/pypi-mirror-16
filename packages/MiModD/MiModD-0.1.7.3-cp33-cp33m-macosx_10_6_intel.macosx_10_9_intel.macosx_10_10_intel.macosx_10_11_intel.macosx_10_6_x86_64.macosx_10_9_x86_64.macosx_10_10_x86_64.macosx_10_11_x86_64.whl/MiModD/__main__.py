...
# +++++++++++ header +++++++++++++
p_samheader = subparsers.add_parser('header', help=help.help_commands['header'])
...
# ++++++++++ convert ++++++++++
p_convert = subparsers.add_parser('convert', help=help.help_commands['convert'],
...
p_reheader = subparsers.add_parser('reheader',
                                   help=help.help_commands['reheader']
                                   )
...
# ++++++++++ sort ++++++++++++
p_sort = subparsers.add_parser('sort', help=help.help_commands['sort'])
...
# +++++++++++ snap ++++++++++++++++++
p_snap = subparsers.add_parser('snap', help=help.help_commands['snap'],
                               parents=[auxparsers.SnapCLParser],
                               conflict_handler='resolve'
                               )
...
p_snap_batch = subparsers.add_parser('snap-batch',
                                     help=help.help_commands['snap-batch']
                                     )
...
# +++++++++++ snap_index ++++++++++++
p_snap_index = subparsers.add_parser('snap-index',
                                     help=help.help_commands['snap-index'],
                                     conflict_handler='resolve'
                                     )
...
# +++++++++++ varcall +++++++++++++
p_varcall = subparsers.add_parser('varcall', help=help.help_commands['varcall'])
...
p_varex = subparsers.add_parser('varextract',
                                help=help.help_commands['varextract']
                                )
...
# +++++++++++ covstats +++++++++
p_stats = subparsers.add_parser('covstats', help=help.help_commands['covstats'])
...
p_vcf_filter = subparsers.add_parser('vcf-filter',
                                     help=help.help_commands['vcf-filter'],
...
p_annotate = subparsers.add_parser('annotate',
                                   help=help.help_commands['annotate']
                                   )
...
p_snpeff_genomes = subparsers.add_parser('snpeff-genomes',
                                         help=help.help_commands['snpeff-genomes']
                                         )
...
p_help.add_argument('topic',
                    nargs='?',
                    help='topic or command for which help is requested. Show command overview if not given.'
                    )
...
def parse (argv=None):
    ...
    if 'module' in args:
        ...
        if 'version' in args:
            ...
            # This is not working under Python 3.2
