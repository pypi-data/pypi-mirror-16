...
links = {
        ...
        1196866 :
            {
            'gene' : 'http://www.yeastgenome.org/cgi-bin/locus.fpl'
                     '?locus={gene}',
            'pos'  : 'http://www.yeastgenome.org/browse/'
                     '?loc={chromosome.shortname}%3A{start}..{stop}'
            },
        # Synechocystis
        1148 :
            {
            'gene' : 'http://genome.microbedb.jp/cyanobase/Synechocystis/genes/'
                     'search?q={gene}&keyword=search&m=gene_symbol%2Cgi_gname%2'
                     'Cdefinition%2Cgi_pname',
            'pos'  : 'http://genome.microbedb.jp/cgi-bin/gbrowse/Synechocystis/'
                     '?name={chromosome.barename}%3A{start}..{stop}'
            },
        # Fly
        7227 :
        ...
        3702 :
            ...
            'pos'  : 'http://tairvm17.tacc.utexas.edu/cgi-bin/gb2/gbrowse/'
                     'arabidopsis/'
