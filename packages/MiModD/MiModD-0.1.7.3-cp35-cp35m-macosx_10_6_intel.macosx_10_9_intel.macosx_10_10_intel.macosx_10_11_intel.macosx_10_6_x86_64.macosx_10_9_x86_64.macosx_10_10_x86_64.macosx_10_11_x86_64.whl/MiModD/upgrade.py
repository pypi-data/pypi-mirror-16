...
if sys.version_info >= (3, 3):
    # Our bundled version of pip does not support Python 3.2.
    # With Python 3.2 we rely on regularly installed versions of pip and
    # setuptools instead.
    # This is error-prone and may prevent the upgrade tool from running on
    # certain systems under Python 3.2, but since the upgrade tool is not
    # essential and given that we will drop Python 3.2 support soon
    # (scheduled for v0.1.8), this simple solution seems acceptable.
