...
class Key(RESTObject):
    ...
    id : str
        The unique key id. This could be randomly generated.

    type : str
        The type of key: "admin", "api", or "monitor"

    endpoints: list of str
        A list of endpoints the api key will work for. Only for api keys.

    adhoc_execute : bool
        Whether this API key is allowed to do adhoc_execute.

        Note: The system-wide adhoc execution must be enabled through
        set_adhoc_execute_configuration for api keys to be able to execute
        adhoc queries, in addition to this being enabled.
    """
    id = RESTProperty(str)
    type = RESTProperty(enum("admin", "api", "monitor"))
    endpoints = RESTProperty(list)
    adhoc_execute = RESTProperty(bool)

    def __init__(self, id=None, type=None, endpoints=None, adhoc_execute=False):
...
class Endpoint(RESTObject):
    ...
    creation_time = RESTProperty(str)
    last_modified_time = RESTProperty(str)
...
class ModelEndpoint(Endpoint):
    ...
    required_files = RESTProperty(str)
    required_packages = RESTProperty(str)
...
class ManagerServiceClient(object):
    ...
    def get_endpoint(self, endpoint_name):
        ...
        return Endpoint(name=name, **attrs)
    ...
    def get_log(self, log_name, start_time, end_time):
    ...
    def get_system_cache_configuration(self):
        ...
        """
        return SystemCacheConfiguration(**self.service_client.GET('configurations/cache'))
    ...
    def set_system_cache_configuration(self, system_cache_configuration):
        ...
        SystemCacheConfiguration
        """
        return SystemCacheConfiguration(
            **self.service_client.PUT('configurations/cache',
                system_cache_configuration.__json__()))
    ...
    def set_endpoint_cache_configuration(self, endpoint_name,
        ...
        return EndpointCacheConfiguration(
            **self.service_client.PUT('configurations/cache/'+endpoint_name,
                endpoint_cache_configuration.__json__()))
    ...
    def get_adhoc_execute_configuration(self):
        ...
        """
        return AdhocExecuteConfiguration(
    ...
    def set_adhoc_execute_configuration(self, adhoc_execute_configuration):
        ...
        return AdhocExecuteConfiguration(
            **self.service_client.PUT('configurations/adhoc_execute',
                adhoc_execute_configuration.__json__()))
    ...
    def get_key(self, key_id='me'):
        ...
        Key object
        """
        return Key(**self.service_client.GET('configurations/keys/'+key_id))
    ...
    def add_key(self, key):
        ...
        return Key(**self.service_client.POST('configurations/keys',
            key.__json__()))
    ...
    def set_key(self, key):
        ...
        """
        return Key(**self.service_client.PUT('configurations/keys/'+key.id,
            key.__json__()))
    ...
    def get_scale_factor_configuration(self):
        ...
        """
        return ScaleFactorConfiguration(
