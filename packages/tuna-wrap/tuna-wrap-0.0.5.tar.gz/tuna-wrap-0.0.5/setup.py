...
setup(
    name='tuna-wrap',
    version='0.0.5',
    description='Wraps Nautilus scripts for use in the Thunar file manager',
    long_description=long_description,
    author='Andreas Fritz, digital.elements.li',
    author_email='tuna-wrap@projects.elements.li',
    url='http://www.elements.li',
    download_url='https://pypi.python.org/pypi/tuna-wrap',
    packages=find_packages(),
    entry_points={'console_scripts':['tuna-wrap=tuna_wrap.wrap'], },
