...
from graphql.pyutils.defer import Deferred
from graphql.execution.middlewares.utils import (
    resolver_has_tag,
    tag_resolver
)
...
class TornadoExecutionMiddleware:
    ...
    def run_resolve_fn(resolver, original_resolver):
        """
            ...
            In order to integrate seemlessly with graphql, the result
            is wrapped in <graphql.pyutils.Deferred> when necessary.
        """
