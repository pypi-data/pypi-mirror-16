...
class PyKeyloggerParser(Parser):
    ...
    def __init__(self, plugin):
        ...
        self.batch_file = os.path.join(os.path.dirname(os.path.realpath(__file__)), "keylogger_parser.bat")

    def parse(self):
        popen = subprocess.Popen(
            [self.batch_file, self.file_or_dir, self.parsed_folder, self.click_dir], cwd=os.path.dirname(os.path.realpath(__file__)),
