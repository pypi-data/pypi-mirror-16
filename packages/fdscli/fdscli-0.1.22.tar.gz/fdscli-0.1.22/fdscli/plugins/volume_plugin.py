...
# Area for actual calls and JSON manipulation        
    ...
    def clone_volume(self, args):
        ...
        if ( args[AbstractPlugin.remote_om_str] is not None ):
            ...
            # policies.
            response = self.get_volume_service().clone_remote( remote_volume )
    ...
    def import_volume(self, args):
        ...
        response = self.get_volume_service().import_volume(
            args[AbstractPlugin.name_str], repository )
    ...
    def export_volume(self, args):
        ...
        response = self.get_volume_service().export_volume( volume, repository )
        if not isinstance( response, FdsError ):
