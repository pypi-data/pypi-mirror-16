...
class VolumeService( AbstractService ):
    ...
    def export_volume(self, volume, repository):
        '''
    ...
    def list_exports_in_bucket(self, repository):
        ...
        for j_export in response:
            export = ExportedVolumeConverter.build_export_from_json( j_export )
    ...
    def clone_remote(self, remote_volume):
