    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('environment', models.IntegerField(default=0, db_column=b'account_integration_environment', choices=[(0, 'Testes'), (1, 'Produ\xe7\xe3o')])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('all_products', models.BooleanField(default=True, db_column=b'integration_all_products')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operation_id', models.BigIntegerField(null=True, db_column=b'integration_history_operation_id', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_id', models.BigIntegerField(null=True, db_column=b'webhook_order_id', blank=True)),
                ('marketplace', models.CharField(max_length=60, null=True, db_column=b'webhook_marketplace', blank=True)),
                ('markeplace_id', models.BigIntegerField(null=True, db_column=b'webhook_marketplace_id', blank=True)),
