...
class Auth(object):
    ...
    def _sign_request(self, req, bucket_name, key):
        ...
        req.headers['Authorization'] = "COS {0}:{1}".format(self.id, signature)
    ...
    def _sign_url(self, req, bucket_name, key, expires):
        ...
        req.params['COSAccessKeyId'] = self.id
    ...
    def __get_resource_string(self, req, bucket_name, key):
        if not bucket_name:
            ...
            return '/{0}/{1}{2}'.format(bucket_name, urlquote(key,''), self.__get_subresource_string(req.params))
