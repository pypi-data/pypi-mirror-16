...
# Target: PythonLibrary(BuildFileAddress(FilesystemBuildFile(/Users/drothstein/src_twitter/commons/src/python/twitter/common/http/BUILD), http))
...
{   'classifiers': [   'Intended Audience :: Developers',
    ...
    'install_requires': [   'twitter.common.lang==0.3.6',
