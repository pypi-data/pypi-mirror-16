...
# @Last Modified time: 2016-07-25 16:38:59
...
def identify(filepath, output_mapping_dir=None):
    # filepath: filepath_step01_extractions
    mapping = {}
    ...
    if output_mapping_dir:
        # output_mapping_dir = os.path.join('/'.join(filepath.split('/')[:-1]), FILIENAME_MAPPING_STEP02)
        file_handler = open(output_mapping_dir, 'wb')
