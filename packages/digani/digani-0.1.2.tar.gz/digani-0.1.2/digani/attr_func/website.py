...
# @Last Modified time: 2016-07-18 19:07:30
...
class AttributeFunctionWebsite(AttributeFunctionBase):
    ...
    def refine(attr_vals):
        ...
        attr_vals = [_.replace('"', '', ) for _ in attr_vals]
        return attr_vals
    ...
    def match(attr_vals):
        ...
        attr_vals = super(AttributeFunctionWebsite, AttributeFunctionWebsite).refine_attr_vals(attr_vals, AttributeFunctionWebsite.refine, do_tokenize=False)
        # print attr_vals
