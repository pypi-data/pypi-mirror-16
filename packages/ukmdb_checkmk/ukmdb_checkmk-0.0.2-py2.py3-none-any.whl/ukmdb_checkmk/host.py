...
class CheckMkHost(object):
    ...
    def __init__(self, context, folder, hostname):
        ...
        ecmd = cmd.GetHost(wato_url=self.context['wato_url'],
    ...
    def ip_address(self, value):
        ...
        ecmd = cmd.EditHost(wato_url=self.context['wato_url'],
                            username=self.context['username'],
                            password=self.context['password'],
                            hostname=self.hostname,
    ...
    def commit(self):
        ...
        ecmd = cmd.ActivateChanges(wato_url=self.context['wato_url'],
                                   username=self.context['username'],
                                   password=self.context['password'])
        result = ecmd.send_request()
        self.request = ecmd.request
