...
class ExtendedTemporalMemory(object):
    ...
    def __init__(self, *args):
        ...
        __init__(self, columnDimensions, cellsPerColumn=32, activationThreshold=13, initialPermanence=0.21, connectedPermanence=0.50, minThreshold=10, maxNewSynapseCount=20, permanenceIncrement=0.10, permanenceDecrement=0.10, predictedSegmentDecrement=0.0, formInternalBasalConnections=True, seed=42, maxSegmentsPerCell=255, maxSynapsesPerSegment=255) -> ExtendedTemporalMemory
        """
    ...
    def initialize(self, *args, **kwargs):
        """initialize(self, columnDimensions, cellsPerColumn=32, activationThreshold=13, initialPermanence=0.21, connectedPermanence=0.50, minThreshold=10, maxNewSynapseCount=20, permanenceIncrement=0.10, permanenceDecrement=0.10, predictedSegmentDecrement=0.0, formInternalBasalConnections=True, seed=42, maxSegmentsPerCell=255, maxSynapsesPerSegment=255)"""
