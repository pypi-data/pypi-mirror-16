...
class CheckRunner(object):
    ...
    def _run_setup_check(self, table, setup_check, reg_check):
        ...
        try:
            ...
            self.run_logger.debug('table: %s, setup results: %s', table, setup_vars.tablecustom_vars)
    ...
    def _run_check(self, table, check, reg_check):
        ...
        self.results.add(table, check, count, rc, reg_check['check_status'],
                         ...
                         run_start_timestamp=start_ts, run_stop_timestamp=stop_ts,
                         data_start_timestamp=foo, data_stop_timestamp=bar)
