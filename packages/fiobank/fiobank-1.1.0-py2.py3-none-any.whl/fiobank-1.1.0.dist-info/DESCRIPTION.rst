...
Description: fiobank
        ...
        `|PyPI version| <https://badge.fury.io/py/redis-collections>`_ `|Build
        Status| <https://travis-ci.org/honzajavorek/fiobank>`_
        
        `Fio Bank API <http://www.fio.cz/bank-services/internetbanking-api>`_ in
        Python.
        ...
        First, `get your API
        token <https://www.fio.cz/ib2/wicket/page/NastaveniPage?3>`_.
        ...
        code <https://github.com/honzajavorek/fiobank/blob/master/fiobank.py>`_.
        ...
        .. |PyPI version| image:: https://badge.fury.io/py/redis-collections.svg
        .. |Build
        Status| image:: https://travis-ci.org/honzajavorek/fiobank.svg?branch=master
