from boolean_solver.code_generator import add_code_to_implementation, translate_to_python_expression
...
class MyTest(unittest.TestCase):
    ...
    def mc_algorithm_and_translate(self, var_names, mc_input, expected_mc_output, expected_exp):
        ...
        """
        mc_set = s.execute_qm_algorithm(mc_input)
    ...
    def get_function_code(self, signature, exp_expected, table):
        ...
        code = add_code_to_implementation(expression, 'def ' + signature)
