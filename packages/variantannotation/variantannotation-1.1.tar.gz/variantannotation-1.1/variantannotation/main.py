...
csv_file = "Tumor_RNAseq_variants.hg19_multianno.csv"
vcf_file = "Tumor_RNAseq_variants.vcf"
os.chdir(filepath)
...
collection_name = 'Tumor_RNA_Variants'
...
filepath = "/Volumes/Seagate Backup Plus Drive/vcf_files/not_annotated"
...
rare_cancer_variants_csv = filepath + "/RNASEQ_filt.csv"
rare_cancer_variants_vcf = filepath + "/RNASEQ_fil.vcf"


#The input gzipped vcf file is required to create a filtered one.
in_vcf_file = "/Volumes/Seagate Backup Plus Drive/vcf_files/Tumor_RNAseq_variants.vcf.gz"
...
my_writer.generate_unfiltered_annotated_vcf(in_vcf_file, rare_cancer_variants_vcf, info_out=False)
