    ...
    try:
        while n == 0 or counts < n:
            ...
            if verify_evidence(engine, db, ev_target, target):
                ...
                r += 1
            engine.previous_result = result
        # if kwdargs['verbose'] > 1 and counts % 10 == 0:
        #     estimates1 = {}
        #     for k in estimates:
        #         estimates1[k] = estimates[k] / counts
        #     total_time = time.time() - start_time
        #     rate = counts / total_time
        #     print(
        #         '%% Probability estimate after %d samples (%.4f samples/second):' % (counts, rate))
        #     print(format_dictionary(estimates1))
