...
ml_predictor.train(training_data, perform_feature_selection=True, X_test=X_test, y_test=y_test, ml_for_analytics=True, compute_power=5, take_log_of_y=False, add_cluster_prediction=True, model_names=['XGBRegressor'])
