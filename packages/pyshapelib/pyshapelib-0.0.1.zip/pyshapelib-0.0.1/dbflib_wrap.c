    ...
    else
    {
		switch (type)
		{
			case FTString:
				...
				{
				PyErr_Format(PyExc_IOError,
						 "can't write field %d of record %d for \"%s\"",
						 field, record, string_value);
				return 0;
				}
				break;
			...
			case FTInteger:
				...
				{
				PyErr_Format(PyExc_IOError,
						 "can't write field %d of record %d for \"%d\"",
						 field, record, int_value);
				return 0;
				}
				break;
			...
			case FTDouble:
				...
				{
				PyErr_Format(PyExc_IOError, "can't write field %d of record %d for \"%f\"", 
							field, record, double_value);
				return 0;
				}
				break;
			...
			case FTLogical:
				...
				if (!string_value)
					return 0;
				if (!DBFWriteLogicalAttribute(handle, record, field, string_value[0]))
				{
					PyErr_Format(PyExc_IOError,
							 "can't write field %d of record %d for \"%c\"",
							 field, record, string_value[0]);
					return 0;
				}
				break;
...
DBFFile * DBFFile_clone(DBFFile *dbf,char const *path) {
    {
        DBFFile * self = malloc(sizeof(DBFFile));
        if (self)
        self->handle = DBFCloneEmpty(dbf->handle, path);
        return self;
    }
}

static PyObject *_wrap_DBFFile_clone(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    DBFFile *arg0 ;
    char *arg1 ;
    DBFFile *result ;
    ...
    if(!PyArg_ParseTuple(args,"Os:DBFFile_clone",&argo0,&arg1)) return NULL;
    ...
    {
        result = (DBFFile *)DBFFile_clone(arg0,(char const *)arg1);
        ;
        if (!result)
        {
            SWIG_exception(SWIG_MemoryError, "no memory");
        ...
        {
            SWIG_exception(SWIG_IOError, "DBFFile_clone failed");
        }
    }resultobj = SWIG_NewPointerObj((void *) result, SWIGTYPE_p_DBFFile);
    return resultobj;
}
...
//wzy add
int  DBFFile_field_index(DBFFile *self,const char *pszFieldName) {
    {
        return DBFGetFieldIndex(self->handle, pszFieldName);
    }
}
//wzy add
static PyObject *_wrap_DBFFile_field_index(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    DBFFile *arg0 ;
    char *arg1 ;
    PyObject * argo0 =0 ;
    ...
    if(!PyArg_ParseTuple(args,"Os:DBFFile_field_index",&argo0,&arg1)) return NULL;
    if ((SWIG_ConvertPtr(argo0,(void **) &arg0,SWIGTYPE_p_DBFFile,1)) == -1) return NULL;
    {
        #ifndef NOCHECK_DBFFile_field_index
        if (!arg0 || !arg0->handle)
        SWIG_exception(SWIG_TypeError, "dbffile already closed");
        #endif
    }
	...
	{
        result = (int )DBFFile_field_index(arg0,(const char *)arg1);

        /*if (result < 0)
        {
			char info[256] = {0};
			strncpy(info, arg1, 255);
			strncat(info, " field_index failed!", 255);
			SWIG_exception(SWIG_IndexError, info);
        }*/
    }
...
//wzy add
int  DBFFile_delete_field(DBFFile *self,int iField) {
    {
        return DBFDeleteField(self->handle, iField);
    }
}

//wzy add
static PyObject *_wrap_DBFFile_delete_field(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    DBFFile *arg0 ;
    int arg1 ;
    PyObject * argo0 =0 ;
    ...
    if(!PyArg_ParseTuple(args,"Oi:DBFFile_delete_field",&argo0,&arg1)) return NULL;
    if ((SWIG_ConvertPtr(argo0,(void **) &arg0,SWIGTYPE_p_DBFFile,1)) == -1) return NULL;
    {
        #ifndef NOCHECK_DBFFile_delete_field
        if (!arg0 || !arg0->handle)
        SWIG_exception(SWIG_TypeError, "dbffile already closed");
        #endif
    }
    {
        result = (int )DBFFile_delete_field(arg0,arg1);
    }resultobj = PyInt_FromLong((long)result);
    return resultobj;
}
...
PyObject * DBFFile_write_record(DBFFile *self,int record,PyObject *dict_or_sequence) {
    {
        return DBFInfo_write_record(self->handle, record, dict_or_sequence);
    }
}
...
int  DBFFile_write_attribute(DBFFile *self,int record,int field,int type,PyObject *value) {
    {
        return write_field(self->handle, record, field, type, value);
    }
}


static PyObject *_wrap_DBFFile_write_attribute(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    DBFFile *arg0 ;
    int arg1 ;
    int arg2 ;
    ...
    if(!PyArg_ParseTuple(args,"OiiiO:DBFFile_write_attribute",&argo0,&arg1,&arg2,&arg3,&obj4)) return NULL;
    if ((SWIG_ConvertPtr(argo0,(void **) &arg0,SWIGTYPE_p_DBFFile,1)) == -1) return NULL;
    {
        arg4 = obj4;
    }
    {
        #ifndef NOCHECK_DBFFile_write_attribute
        if (!arg0 || !arg0->handle)
        SWIG_exception(SWIG_TypeError, "dbffile already closed");
        #endif
    }
    result = (int )DBFFile_write_attribute(arg0,arg1,arg2,arg3,arg4);
    resultobj = PyInt_FromLong((long)result);
    return resultobj;
}
...
static PyMethodDef dbflibMethods[] = {
	 ...
	 { "DBFFile_field_index", _wrap_DBFFile_field_index, METH_VARARGS },
	 ...
	 { "DBFFile_write_attribute", _wrap_DBFFile_write_attribute, METH_VARARGS },
	 { "DBFFile_commit", _wrap_DBFFile_commit, METH_VARARGS },
	 { "DBFFile_delete_field", _wrap_DBFFile_delete_field, METH_VARARGS },
	 { "DBFFile_clone", _wrap_DBFFile_clone, METH_VARARGS },
	 { NULL, NULL }
};
...
SWIGEXPORT(void) initdbflibc(void) {
    ...
    m = Py_InitModule("dbflibc", dbflibMethods);
