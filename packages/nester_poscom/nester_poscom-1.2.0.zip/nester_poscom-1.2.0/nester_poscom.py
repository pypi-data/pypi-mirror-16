...
"""This is the nester.py module, and it provides one function called print_lol() which prints list that may or may
not include nested lists. """
def print_lol(the_list, level=-1000):
    ...
    to the screen on its own line. A second argument called "level" is used to insert
