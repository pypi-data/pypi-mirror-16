...
def create(label, bgs_type, type_options):
...
def add_image_id(background_subtractor_id, image_id, learning_rate, encode_type):
    """
...
def add_image(background_subtractor_id, image, learning_rate, encode_type):
    """
...
def add_image_url(background_subtractor_id, url, learning_rate, encode_type):
    """
    Add a new image to a background subtractor.
    """
    params = {
