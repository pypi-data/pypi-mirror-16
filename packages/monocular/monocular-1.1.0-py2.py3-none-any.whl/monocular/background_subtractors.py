...
def create(label, bgs_type='MOG', type_options=None):
    ...
    params = util.merge_two_dicts(options, type_options)
    return api.post(path, params)

def add_image_id(background_subtractor_id, image_id, learning_rate=-1, encode_type=None):
    """
...
def add_image(background_subtractor_id, image, learning_rate=-1, encode_type=None):
    """
    Add a new image to a background subtractor.
    """
    path = '{0}/{1}/add/'.format(BGS_ENDPOINT, background_subtractor_id)
...
def add_image_url(background_subtractor_id, url, learning_rate=-1, encode_type=None):
    """
    Add a new image to a background subtractor.
    """
    path = '{0}/{1}/add/'.format(BGS_ENDPOINT, background_subtractor_id)
