Preamble: This Agreement, actioned on May 12, 2016 (hereinafter: Effective Date) governs the relationship between Licensee, a Business Entity or individual, (hereinafter: Licensee) and Jemsoft Pty Ltd, a duly registered company in whose principal place of business is L1 15-17 Featherstone Place, Adelaide, SA, 5000 (hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using Jemsoft Monocular Python SDK (hereinafter: The Software) created and owned by Licensor, as detailed herein
...
Description: Monocular Python SDK
        ====================
        ...
        Upload distribution
        `twine upload dist/monocular-[version]-py2.py3-none-any.whl`
        
        then provide the username and password
        
Keywords: monocular,sdk,computer,vision,images,object,tracking,face,detection
Platform: UNKNOWN
