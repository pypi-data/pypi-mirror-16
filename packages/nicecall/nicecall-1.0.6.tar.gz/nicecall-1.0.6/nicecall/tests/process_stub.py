...
class ProcessStub(nicecall.Process):
    def __init__(
            self, on_stdout=None, on_stderr=None, filters=None, matches=None):
        self._matches = matches or {}
        super().__init__(on_stdout, on_stderr, filters)
    ...
    def _clone(self):
        return self.__class__(
            self._on_stdout, self._on_stderr, self._filters, self._matches)
