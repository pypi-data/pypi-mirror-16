...
class Api(_CommonAPIClass):
		...
		class _Blueprints(_CommonAPIClass):
			...
			class _Exports(_CommonAPIClass):
				...
				class _Downloads(_CommonAPIClass):
					...
					#URL: users/{uid}/blueprints/{bpid}/exports/{epid}/downloads/{fileName}
					def Download(self, Downloadid, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {'downloadId': Downloadid}
						return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/exports/' + str(self._get('Epid')) + '/downloads/' + str(self._get('Filename')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
	...
	class _Orgs(_CommonAPIClass):
		...
		class _Logos(_CommonAPIClass):
			...
			#URL: orgs/{oid}/logos/{slogoid}/{fileName}
			def Get(self, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {}
				return self._REST('/orgs/' + str(self._get('Oid')) + '/logos/' + str(self._get('Slogoid')) + '/' + str(self._get('Filename')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
