...
tinyMCE.init({
    ...
    theme_advanced_buttons1: "formatselect,styleselect,|,bold,italic,underline,|,bullist,numlist,blockquote,|,undo,redo,|,link,unlink,|,image,|,fullscreen,|,wladmin_adv",
    theme_advanced_buttons2: "search,|,pasteword,template,media,charmap,|,code,|,table,cleanup,wladmin_documentstructure",
    ...
    // plugins
    plugins: "advimage,advlink,fullscreen,paste,media,searchreplace,wladmin,wladmin_contextmenu,template",
    advimage_update_dimensions_onchange: true,

    // wladmin settings
    wladmin_adv_hidden: false,
    wladmin_show_documentstructure: 'on',

    // templates
    template_templates: [
        {
            title: "2 Spalten, symmetrisch",
            src: "/wladmin/tinymce/templates/2col/",
            description: "Symmetrical 2 Columns."
        },
        {
            title: "2 Spalten, symmetrisch mit Unterteilung",
            src: "/wladmin/tinymce/templates/4col/",
    ...
    + "-li,"
    + "br,"
    + "img[class|src|alt=|width|height]," + +"-h2,-h3,-h4," + +"-pre," + +"-blockquote," + +"-code," + +"-div",
