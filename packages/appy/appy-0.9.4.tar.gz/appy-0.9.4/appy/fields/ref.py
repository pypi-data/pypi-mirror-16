...
class Ref(Field):
    ...
    pxLink = Px('''
     <a target="appyIFrame"
      ...
      <div var="labelId=(popupMode=='repl') and 'search_button' or 'add_ref';
                icon=(popupMode == 'repl') and 'search' or 'add';
                label=_(labelId);
                css=ztool.getButtonCss(label);
                float=field.getSearchButtonCssFloat()"
    ...
    pxViewList = Px('''
     <div id=":ajaxHookId">
      <div if="isView or mayAdd or mayLink" style="margin-bottom: 4px">
    ...
    pxView = Px('''
     <x var="layoutType=layoutType|req.get('layoutType', 'view');
             ...
             mayEdit=isView and zobj.mayEdit(field.writePermission);
    ...
    pxSearch = Px('''
     ...
     <!-- The list of values -->
     <select var="objects=field.getPossibleValues(ztool, forSearch=True);
    ...
    def __init__(self, klass=None, attribute=None, validator=None,
      ...
      menuUrlMethod=None, menuCss=None, view=None, xml=None, showActions=True,
      collapsible=False, links=True):
        ...
        Field.__init__(self, validator, multiplicity, default, show, page,
          ...
          sdefault, scolspan, swidth, sheight, persist, False, view, xml)
    ...
    def getPossibleValues(self, obj, startNumber=None, someObjects=False,
                          removeLinked=False, maxPerPage=None, forSearch=False):
        '''This method returns the list of all objects that can be selected
           ...
           If p_forSearch is True, it lists possible values for a search screen.
        '''
        req = obj.REQUEST
        obj = obj.appy()
