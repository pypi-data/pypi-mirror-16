...
class Date(Field):
    ...
    def __init__(self, validator=None, multiplicity=(0,1), default=None,
      ...
      reverseYears=False, show=True, page='main', group=None, layouts=None,
      ...
      focus=False, historized=False, mapping=None, label=None, sdefault=None,
      scolspan=1, swidth=None, sheight=None, persist=True, view=None, xml=None,
      showDay=True):
        self.format = format
