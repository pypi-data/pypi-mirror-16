...
from simple_permissions.backends import PermissionBackend
from simple_permissions.utils.handlers import registry
from simple_permissions.tests.utils import create_user
from simple_permissions.tests.utils import create_article
from simple_permissions.tests.models import Article
from simple_permissions.tests.compat import MagicMock
from simple_permissions.tests.compat import override_settings


@override_settings(
    AUTHENTICATION_BACKENDS=(
        'django.contrib.auth.backends.ModelBackend',
        'simple_permissions.backends.PermissionBackend',
    ),
)
