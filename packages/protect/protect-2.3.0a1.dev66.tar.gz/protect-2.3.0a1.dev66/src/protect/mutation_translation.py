...
def run_transgene(job, snpeffed_file, univ_options, transgene_options, fusion_calls=None):
    """
    ...
    if fusion_calls:
        ...
        docker_call(tool='transgene:2.0--604064114e4be401a61f989923cff210fd6c71f6',
