...
class Table(BaseElement):
    ...
    Наследуется от класса BaseElement
    """
    ...
    def get_header(self, index):
        ...
        """
        if self.header.get(index) is not None:
            return self.header.get(index)
    ...
    def get_header_values(self):
        ...
        Returns:
            Список (list) текстовых значений всех WebElement-ов заголовка таблицы.
    ...
    def get_row(self, index):
        ...
        Returns:
              Словарь ячеек строки, ключов к кором является наименования заголовка (колонки), значением - WebElement
              {
                'Company': <WebElement, element="4")>,
                'Country': <WebElement, element="6")>, ...
              }
