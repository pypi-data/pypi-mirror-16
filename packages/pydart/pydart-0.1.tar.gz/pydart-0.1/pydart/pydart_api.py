...
def setCollisionDetector(*args):
  return _pydart_api.setCollisionDetector(*args)
setCollisionDetector = _pydart_api.setCollisionDetector

def printCollisionDetector(*args):
  return _pydart_api.printCollisionDetector(*args)
...
def checkCollisionWorld(*args):
  return _pydart_api.checkCollisionWorld(*args)
...
def changeRootJointToTransAndEuler(*args):
  return _pydart_api.changeRootJointToTransAndEuler(*args)
...
def getSkeletonPositionDifferences(*args):
  return _pydart_api.getSkeletonPositionDifferences(*args)
getSkeletonPositionDifferences = _pydart_api.getSkeletonPositionDifferences

def getSkeletonVelocityDifferences(*args):
  return _pydart_api.getSkeletonVelocityDifferences(*args)
...
def getMarkerLocalPosition(*args):
  return _pydart_api.getMarkerLocalPosition(*args)
