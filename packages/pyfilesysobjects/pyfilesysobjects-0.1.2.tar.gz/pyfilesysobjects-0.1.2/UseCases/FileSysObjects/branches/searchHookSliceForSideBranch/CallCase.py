...
class CallUnits(unittest.TestCase):
    ...
    def testCase1001b(self):
        """1. search and create a path for a side branch"""
        import testdata
 
        sp = os.path.normpath('a/b[0123]/[c]*')
        expected = os.path.normpath(testdata.mypath+'/examples/a/b[0123]/[c]*')
        rp = getTopFromPathString(sp,self._plist)
        assert expected == rp 
 
    def testCase1001c(self):
        """1. search and create a path for a side branch"""
        import testdata
