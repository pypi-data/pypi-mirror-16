...
class CallUnits(unittest.TestCase):
    ...
    def testCase000(self):
        ...
        retx = 'UseCases.filesysobjects.PySourceInfo.getCallerFuncNameOID.CallCase.CallUnits.testCase000'
        assert retx == ret

    def testCase001(self):
        ret = filesysobjects.PySourceInfo.getCallerNameOID(1)
        retx = 'UseCases.filesysobjects.PySourceInfo.getCallerFuncNameOID.CallCase.CallUnits.testCase001'
        assert retx == ret
