...
setup(
    description='Rask Riak Connector',
    install_requires=[
        'rask',
    ],
    license='https://gitlab.com/vikingmakt/rask_njord_riak/raw/master/LICENSE',
    maintainer='Umgeher Torgersen',
    maintainer_email='me@umgeher.org',
    name='rask_njord_riak',
    packages=find_packages(),
    url='https://gitlab.com/vikingmakt/rask_njord_riak',
    version=git_version()
)
