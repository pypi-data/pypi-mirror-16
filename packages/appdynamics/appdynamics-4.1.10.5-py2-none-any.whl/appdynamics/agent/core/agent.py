...
class Agent(object):
    ...
    def on_start_node_response(self, response):
        if self.config_svc is None:
            ...
            self._tx_factory = make_transaction_factory(self.timer, self.error_config_registry.is_bt_error)
    ...
    def update_config(self, config):
        ...
        self.eum_enabled = config.eumConfig.enabled
