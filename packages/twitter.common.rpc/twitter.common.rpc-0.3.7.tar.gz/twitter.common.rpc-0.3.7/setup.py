...
# Target: PythonLibrary(BuildFileAddress(FilesystemBuildFile(/Users/kwilson/dev/commons/src/python/twitter/common/rpc/BUILD), rpc-packaged))
...
{   'classifiers': [   'Intended Audience :: Developers',
    ...
    'install_requires': [   'thrift',
                            ...
                            'twitter.common.finagle-thrift==0.3.7'],
