    ...
    try:
        ...
        if int(major) == 0 and int(minor) <= 12:
            ...
            try:
                ...
                print "[*] Successfully removed the deprecated installation. Installation will resume now to install it..."
            ...
            print "[*] OSRFramework is already installed. The setup script will upgrade it now."
            break
    except Exception as e:
        print str(e)
