...
def quotedata(data):
    ...
    """
    return re_qd1.sub('..', re_qd2.sub(CRLF, data))

re_qp = re.compile(br'(?m)^\.')
def _quote_periods(bindata):
    return re_qp.sub(b'..', bindata)

re_feol = re.compile(r'(?:\r\n|\n|\r(?!\n))')
def _fix_eols(data):
    return  re_feol.sub(CRLF, data)
