...
@expose('kajiki:turbopress.templates.articles')
...
@expose('kajiki:turbopress.templates.article_preview')
...
@expose('kajiki:turbopress.templates.articles_excerpts')
...
@expose('kajiki:turbopress.templates.article_excerpt')
def excerpt(article):
