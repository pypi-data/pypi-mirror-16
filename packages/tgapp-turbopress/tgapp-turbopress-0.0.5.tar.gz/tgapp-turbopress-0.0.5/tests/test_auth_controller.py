...
from .base import configure_app, create_app, flush_db_changes, norm_html
...
class TurboPressAuthControllerTests(object):
    ...
    def test_blog_save(self):
        ...
        resp_text = norm_html(resp)
        assert '''<div id="turbopress_articles"> </div>''' in resp_text, resp_text
