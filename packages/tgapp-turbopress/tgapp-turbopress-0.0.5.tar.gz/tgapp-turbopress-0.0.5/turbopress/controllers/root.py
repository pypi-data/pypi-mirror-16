...
class RootController(TGController):
    ...
    @expose('kajiki:turbopress.templates.index')
    @paginate('articles')
    ...
    @expose('kajiki:turbopress.templates.article')
    ...
    @expose('kajiki:turbopress.templates.manage')
    @paginate('articles')
    ...
    @expose('kajiki:turbopress.templates.edit')
    ...
    @expose('kajiki:turbopress.templates.attachments')
    def attach(self, **kw):
        article = model.provider.get_obj(model.Article, params=dict(uid=kw['article'],
                                                                    _id=kw['article']))
