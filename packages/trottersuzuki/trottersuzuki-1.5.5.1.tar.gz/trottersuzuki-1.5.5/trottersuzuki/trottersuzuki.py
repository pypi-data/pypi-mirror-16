...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_trottersuzuki')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_trottersuzuki')
...
class Lattice(_object):
    ...
    if _newclass:
        global_dim_x = _swig_property(_trottersuzuki.Lattice_global_dim_x_get, _trottersuzuki.Lattice_global_dim_x_set)
    ...
    if _newclass:
        global_dim_y = _swig_property(_trottersuzuki.Lattice_global_dim_y_get, _trottersuzuki.Lattice_global_dim_y_set)
    ...
    if _newclass:
        periods = _swig_property(_trottersuzuki.Lattice_periods_get, _trottersuzuki.Lattice_periods_set)
    __swig_setmethods__["halo_x"] = _trottersuzuki.Lattice_halo_x_set
    __swig_getmethods__["halo_x"] = _trottersuzuki.Lattice_halo_x_get
    if _newclass:
        halo_x = _swig_property(_trottersuzuki.Lattice_halo_x_get, _trottersuzuki.Lattice_halo_x_set)
    __swig_setmethods__["halo_y"] = _trottersuzuki.Lattice_halo_y_set
    __swig_getmethods__["halo_y"] = _trottersuzuki.Lattice_halo_y_get
    if _newclass:
        halo_y = _swig_property(_trottersuzuki.Lattice_halo_y_get, _trottersuzuki.Lattice_halo_y_set)
    ...
    if _newclass:
        end_x = _swig_property(_trottersuzuki.Lattice_end_x_get, _trottersuzuki.Lattice_end_x_set)
    __swig_setmethods__["end_y"] = _trottersuzuki.Lattice_end_y_set
    __swig_getmethods__["end_y"] = _trottersuzuki.Lattice_end_y_get
    if _newclass:
        end_y = _swig_property(_trottersuzuki.Lattice_end_y_get, _trottersuzuki.Lattice_end_y_set)
    ...
    if _newclass:
        inner_start_x = _swig_property(_trottersuzuki.Lattice_inner_start_x_get, _trottersuzuki.Lattice_inner_start_x_set)
    ...
    if _newclass:
        inner_start_y = _swig_property(_trottersuzuki.Lattice_inner_start_y_get, _trottersuzuki.Lattice_inner_start_y_set)
    ...
    if _newclass:
        inner_end_x = _swig_property(_trottersuzuki.Lattice_inner_end_x_get, _trottersuzuki.Lattice_inner_end_x_set)
    ...
    if _newclass:
        inner_end_y = _swig_property(_trottersuzuki.Lattice_inner_end_y_get, _trottersuzuki.Lattice_inner_end_y_set)
    ...
    if _newclass:
        mpi_coords = _swig_property(_trottersuzuki.Lattice_mpi_coords_get, _trottersuzuki.Lattice_mpi_coords_set)
    ...
    if _newclass:
        mpi_dims = _swig_property(_trottersuzuki.Lattice_mpi_dims_get, _trottersuzuki.Lattice_mpi_dims_set)
    ...
    if _newclass:
        mpi_rank = _swig_property(_trottersuzuki.Lattice_mpi_rank_get, _trottersuzuki.Lattice_mpi_rank_set)
    ...
    if _newclass:
        mpi_procs = _swig_property(_trottersuzuki.Lattice_mpi_procs_get, _trottersuzuki.Lattice_mpi_procs_set)
...
class State(_object):
    ...
    if _newclass:
        p_real = _swig_property(_trottersuzuki.State_p_real_get, _trottersuzuki.State_p_real_set)
    __swig_setmethods__["p_imag"] = _trottersuzuki.State_p_imag_set
    __swig_getmethods__["p_imag"] = _trottersuzuki.State_p_imag_get
    if _newclass:
        p_imag = _swig_property(_trottersuzuki.State_p_imag_get, _trottersuzuki.State_p_imag_set)
