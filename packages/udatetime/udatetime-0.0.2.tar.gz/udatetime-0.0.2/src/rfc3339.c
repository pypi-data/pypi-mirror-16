...
//     date_struct d = {0, 0, 0, 0, 0};
//     time_struct t = {0, 0, 0, 0, 0, 0};
//     date_time_struct dt = {d, t, 0};

//     _localnow(&dt);

//     // _parse_date_time("2016-07-15 T 12:33:20.123 + 01:30", &dt);
//     // printf("Status: %d\n", dt.ok);
//     // printf("Offset: %d\n", dt.time.offset);

//     // _parse_date_time("2016-07-15 T 12:33:20.123 Z", &dt);
//     // printf("Status: %d\n", dt.ok);
//     // printf("Offset: %d\n", dt.time.offset);

//     // _parse_date_time("2016-07-15 T 12:33:20.12", &dt);
//     // printf("Status: %d\n", dt.ok);
//     // printf("Offset: %d\n", dt.time.offset);

//     // _parse_date_time("2016-07-15 T 12:33:20", &dt);
//     // printf("Status: %d\n", dt.ok);
//     // printf("Offset: %d\n", dt.time.offset);

//     // _parse_date_time("12:33:20", &dt);
//     // printf("Status: %d\n", dt.ok);
//     // printf("Offset: %d\n", dt.time.offset);
