    ...
    return {
        ...
        'create_cluster': {
            ...
            'option': {
                ...
                'type': "optional, instanceType, type '%s t' for more, default: %s" % (CMD, INS_TYPE),
        ...
        'submit': {
            ...
            'option': {
                'cluster': """optional, should be a cluster_id, or an auto_cluster string.
                                      ...
                                      (image default: %s, type '%s i' for more images)
                                      (instanceType default: %s, type '%s t' for more instanceTypes). """ % (
                IMG_ID, INS_TYPE, CMD, IMG_ID, INS_TYPE, CMD, CMD),
            ...
            'update': {
                ...
                'option': {
                    'cluster': """optional, should be a cluster_id, or an auto_cluster string.
                              ...
                              or use auto cluster, format: img=<imageId>:type=<instanceType>
                              (image default: %s, type '%s i' for more images)
                              (instanceType default: %s, type '%s t' for more instanceType). """
                    % (IMG_ID, INS_TYPE, CMD,IMG_ID, INS_TYPE,CMD, CMD),
