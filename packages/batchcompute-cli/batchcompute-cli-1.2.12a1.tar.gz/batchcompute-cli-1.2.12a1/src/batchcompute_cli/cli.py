...
from .action import login, config, info, cluster, job, cluster_create, cluster_delete, cluster_update, instance_type \
    ...
    ,image,image_create,image_delete
...
class Cli:
    ...
    Examples:
        ...
        cmd_create_cluster.option("-u, --user_data [key1:value1,key2:value1...]",
    ...
    Examples:
        ...
        cmd_submit_job.option("-u,--user_data [key1:value1,key2:value1...]", MSG['submit']['option']['user_data'])
