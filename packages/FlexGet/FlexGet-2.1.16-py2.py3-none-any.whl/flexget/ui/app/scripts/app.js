...
(function () {
    ...
    appRun.$inject = ["authService", "routerHelper", "toolBarService"];
    angular
        .module("components.auth")
		.run(appRun);
...
(function () {
    ...
    toolbarController.$inject = ["sideNavService", "toolBarService"];
    angular
		.module('components.toolbar')
        .component('toolBar', {
...
(function () {
	...
	toolbarSetup.$inject = ["toolBarService"];
	angular
		.module('components.toolbar')
		.run(toolbarSetup)
...
(function () {
	...
	appRun.$inject = ["$state", "routerHelper", "toolBarService"];
    angular
		.module("plugins.config")
		.run(appRun);
...
(function () {
    ...
    configService.$inject = ["$http", "exception"];
    angular
		.module('plugins.config')
...
(function () {
	...
	appRun.$inject = ["routerHelper", "toolBarService", "$state"];
    angular
		.module("plugins.log")
		.run(appRun);
...
(function () {
    ...
    logService.$inject = ["$http", "exception", "$q"];
    angular
		.module('plugins.log')
...
(function () {
    ...
    seriesController.$inject = ["$mdDialog", "seriesService", "$timeout", "$mdMedia"];
    angular
        .module('plugins.series')
...
(function () {
	...
	appRun.$inject = ["serverService", "toolBarService"];
    angular
		.module("plugins.server")
		.run(appRun);
...
(function () {
	...
	movieListController.$inject = ["moviesService", "$mdDialog"];
	angular
		.module('plugins.movies')
		.component('movieList', {
...
(function () {
    ...
    episodesReleaseController.$inject = ["$http", "$filter", "$mdDialog", "seriesService"];
    angular
		.module('plugins.series')
...
(function () {
    ...
    seriesEpisodeController.$inject = ["$mdDialog", "$http", "seriesService"];
    angular
		.module('plugins.series')
