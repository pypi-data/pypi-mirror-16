...
class CSendSMTPMail:
    ...
    def SendMail(self, sToEMail, sSubject, sContent, sFromTitle='缺省身份'):
        ...
        CatchExcepExitParam('SendMail',self.__sendMail, sToEMail, sSubject, sContent, sFromTitle=sFromTitle)
        return self.bSendEMailOK
