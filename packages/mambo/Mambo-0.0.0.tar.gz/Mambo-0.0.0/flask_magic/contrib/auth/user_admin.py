...
def setup(**kwargs):
    ...
    @set_nav(title=nav_kwargs.pop("title", "User Admin") or "User Admin",
    ...
    class AuthUserAdmin(Magic):
        ...
        @set_nav("User Info", visible=False)
        def info(self, id):
        ...
        def reset_password(self):
            ...
            try:
                ...
                if not user_login:
                    raise AppError("This account doesn't have an email login type")
                email_reset_password(user_login)
            except AppError as ae:
                flash_error(ae.message)
