...
logger = logging.getLogger('elasticsearch1.helpers')
...
def expand_action(data):
    ...
    :meth:`~elasticsearch1.Elasticsearch.bulk` api.
    """
...
def streaming_bulk(client, actions, chunk_size=500, max_chunk_bytes=100 * 1014 * 1024,
    ...
    :func:`~elasticsearch1.helpers.bulk` which is a wrapper around streaming
    bulk that returns summary information about the bulk operation once the
    entire input is consumed and sent.


    :arg client: instance of :class:`~elasticsearch1.Elasticsearch` to use
...
def bulk(client, actions, stats_only=False, **kwargs):
    """
    Helper for the :meth:`~elasticsearch1.Elasticsearch.bulk` api that provides
    ...
    See :func:`~elasticsearch1.helpers.streaming_bulk` for more accepted
    parameters
    ...
    :func:`~elasticsearch1.helpers.streaming_bulk` which is used to execute
    the operation.
    """
    success, failed = 0, 0
...
def scan(client, query=None, scroll='5m', raise_on_error=True,
    ...
    :meth:`~elasticsearch1.Elasticsearch.scroll` api - a simple iterator that
    ...
    :arg client: instance of :class:`~elasticsearch1.Elasticsearch` to use
    :arg query: body for the :meth:`~elasticsearch1.Elasticsearch.search` api
    ...
    :meth:`~elasticsearch1.Elasticsearch.search` call::
...
def reindex(client, source_index, target_index, query=None, target_client=None,
    ...
    :arg client: instance of :class:`~elasticsearch1.Elasticsearch` to use (for
    ...
    :arg scan_kwargs: additional kwargs to be passed to
        :func:`~elasticsearch1.helpers.scan`
    :arg bulk_kwargs: additional kwargs to be passed to
        :func:`~elasticsearch1.helpers.bulk`
    """
